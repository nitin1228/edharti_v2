<?php $__env->startSection('title', 'Customized Report'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="filter-form" method="get" action="<?php echo e(route('customizeReport')); ?>">
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="report_type" id="report_type" class="form-select">
                            ...
                            <?php $__currentLoopData = $reportTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $reportType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('report_type') == $key ? 'selected' : ''); ?>>
                        ...
                        <?php if($errors->has('report_type')): ?>
                            <div class="text-danger"><?php echo e($errors->first('report_type')); ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="col-md-3 mb-3" id="sectionDiv" style="display: none;">
                        ...
                        <select name="section" id="section" class="form-select">
                            ...
                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($section->id); ?>"><?php echo e($section->section_code); ?>
                        ...
                        <?php if($errors->has('section')): ?>
                            <div class="text-danger"><?php echo e($errors->first('section')); ?></div>
                        <?php endif; ?>
                    </div>
    ...
    <script>
                ...
                if (reportType) {
                    ...
                    if (columns) {
                        ...
                        $('#reportTable').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '<?php echo e(route('get.customized.reports.data')); ?>',
                                data: {
        ...
        document.getElementById('export-pdf-btn').addEventListener('click', async function() {
            ...
            try {
                ...
                const url =
                    `<?php echo e(route('get.customized.reports.data')); ?>?report_type=${reportType}&section=${section}&export_format=${export_format}`;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/report/customize-report-new.blade.php ENDPATH**/ ?>