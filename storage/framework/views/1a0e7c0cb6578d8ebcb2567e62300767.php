<?php $__env->startSection('title', 'Club Membership List'); ?>
            ...
            <div class="d-flex justify-content-between align-items-end flex-wrap py-3 gap-2">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('create.club.membership.form')); ?>">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#example').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('get.club.membership.received.list')); ?>",
                    data: function(d) {
            ...
            $('.send-bulk-email').on('click', function() {
                ...
                $.ajax({
                    url: '<?php echo e(route('club.membership.bulk.email')); ?>',
                    method: 'POST',
                    data: {
                        ids: selectedIds,
                        type: type,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/club_membership/index_received.blade.php ENDPATH**/ ?>