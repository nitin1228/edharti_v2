...
<?php if(strpos( url()->current(), '/reports') || strpos( url()->current(), '/reports/detailed-report') || strpos( url()->current(), '/dashboard/main')): ?>
<!-- commented and adeed by anil for replace the new loader on 08-08-2025  -->
...
<?php /**PATH C:\Users\WORK\Laravel\Development Server\edharti_v2\resources\views/include/loader.blade.php ENDPATH**/ ?>