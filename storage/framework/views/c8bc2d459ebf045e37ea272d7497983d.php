...
<?php $__env->startSection('title', 'Filter Report'); ?>
                        ...
                        <div class="d-flex align-items-start w-btn-full flex-wrap">
                            ...
                            <div class="relative-input mb-3 mr-2">
                                <select class="selectpicker" aria-label="Land" aria-placeholder="Land" data-live-search="true" title="Land" id="land-type">
                                    ...
                                    <option value="<?php echo e($landType->id); ?>"><?php echo e($landType->item_name); ?></option>
                            ...
                            <div class="relative-input mb-3 mr-2">
                                <select class="selectpicker multipleSelect" multiple aria-label="Land Status" data-live-search="true" title="Land Status" id="land-status" name="property_status[]">
                                    ...
                                    <option value="<?php echo e($status->id); ?>"><?php echo e($status->item_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 mr-2">
                                <select class="selectpicker colony" multiple aria-label="Search by Colony" data-live-search="true" title="Colony (<?php echo e($colonyList->count()); ?>)" id="colony_filter" name="colony[]">
                                    <option value="">All</option>
                                            ...
                                            <div class="tab-content list-right-size">
                                                ...
                                                <div class="tab-pane fade" id="LeaseDeed" role="tabpanel">
                                                    <ul class="sub-list-checkbox-items">
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox" value="<?php echo e($leaseType->id); ?>">
                                                                <label class="form-check-label"><?php echo e($leaseType->item_name); ?></label>
                                                            </div>
                                                        </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card group_filters_containers sticky-next">
            <div class="card-body">
...
<?php echo $__env->make('report.due-demand', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script src="<?php echo e(asset('assets/js/knobs.min.js')); ?>"></script>
...
<script>
        var streetViewUrl = "<?php echo e(route('streetview', ['id' => '__ID__'])); ?>";
    ...
    const propertyDetailsRoute = "<?php echo e(route('viewPropertyDetails', ['property' => '__ID__'])); ?>";
    const streetviewRoute = "<?php echo e(route('streetview', ['id' => '__ID__'])); ?>"; 
    ...
    const spinnerOverlay = document.getElementById('spinnerOverlay');
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo e(route("getPropertyResults")); ?>',
            data: {
            ...
            success: (results) => {
                ...
                if (results.counter > 0) {
                    ...
                    results.rows.forEach((row, index) => {
                        ...
                        const streetViewHtml = `<a href="${dynamicStreetviewRoute}" target="_blank" data-toggle="tooltip" title="View Streetview">
                            <span class="location_icon">
                                <img src="<?php echo e(asset('assets/images/street-view.svg')); ?>" class="map-marker-icon" />
                            </span>
                        </a>`;
                    ...
                    updatedListHTML += `<div class="d-flex justify-content-center align-items-center" style="height: 100px;">
					<h3>Search property does not belong to your sections</h3>
					</div>`;
                }
    ...
    $('.export-btn').click(function() {
        ...
        $.ajax({
            type: "post",
            url: '<?php echo e(route("reportExport")); ?>',
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                format: exportFormat,
                filters: filters
    ...
    // script.js
   // commented by anil on 17/3/2026
    //$(document).ready(function() {
      //  var stickyDiv = $('.sticky-div');
        ...
        //});
    //});
    //added by anil on 17/3/2026
    $(document).ready(function() {
        var stickyDiv = $('.sticky-div');
        var stickyNext = $('.sticky-next');
        var stickyOffset = stickyDiv.offset().top;

        $(window).scroll(function() {
            if ($(window).scrollTop() >= stickyOffset) {
                stickyDiv.addClass('sticky');
                stickyNext.addClass('sticky-space');
            } else {
                stickyDiv.removeClass('sticky');
                stickyNext.removeClass('sticky-space');
            }
        });
    });
...
$.ajax({
    ...
    url: '<?php echo e(route("getDemandDetails")); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WORK\Laravel\Development Server\edharti_v2\resources\views/report/report.blade.php ENDPATH**/ ?>