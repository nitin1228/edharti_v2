...
<?php $__env->startSection('title', 'Property Inspection Request'); ?>
...
<style>.card {
    ...
    ?>
        ...
        <input type="text"  name="oldPropertyId" id="oldPropertyId" class="form-control" placeholder="Enter property id" value="<?php echo e($inspection->property_id ?? ''); ?>"  <?php echo e($isEdit ? 'readonly' : ''); ?>>
      <input type="hidden"  id="inspectionId" value="<?php echo e($inspection->id ?? ''); ?>">
        </div>
        <?php if(!$isEdit): ?>
        <div class="col-md-4">
      ...
      <input type="text" class="form-control"value="<?php echo e($inspection->inspection_id ?? ''); ?>" readonly>
      </div>
        <?php endif; ?>
    </div>
  </div>
            ...
            <div class="d-none" id="detail-card">               
                ...
                <div id="errorDiv" style="color: red; display: none;"></div> <!-- Error container -->
                 <?php if(!isset($inspectionreport)): ?>                
                 <?php if(isset($type) && $type == 'breachnotice'): ?>
			...
			?>
				    ...
				    <div class="col-md-3"><input type="text" class="form-control " value="<?php echo e($isBreach ? ($address->bname ?? '') : ($address->pname ?? '')); ?>" id="bname"> </div>
				    </div>
				    <div class="row mb-2 align-items-center">
			        <div class="col-md-2">  <b>Email Address</b> </div>
			        <div class="col-md-3">  <input type="email"  class="form-control" id="binspection_email" placeholder="Enter email address"  value="<?php echo e($isBreach ? ($address->binspection_email ?? '') : ($address->inspection_email ?? '')); ?>"></div>
			        <div class="col-md-2 text-end">  <b>Phone Number</b>   </div>
			        <div class="col-md-3"> <input type="text"   class="form-control" id="binspection_phone"  placeholder="Enter phone number" value="<?php echo e($isBreach ? ($address->binspection_phone ?? '') : ($address->inspection_phone ?? '')); ?>" >
			        </div>
			    </div>
				<div class="row mb-2 align-items-center">				  
				     <div class="col-md-2 "> <b>House No/Street name</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control " value="<?php echo e($isBreach ? ($address->bhouse ?? '') : ($address->phouse ?? '')); ?>" id="bhouse"></div>
                     <div class="col-md-2 text-end"><b> Locality</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($isBreach ? ($address->blocality ?? '') : ($address->plocality ?? '')); ?>" id="blocality"> </div>				
				</div>
				<div class="row mb-2 align-items-center">				   
				      <div class="col-md-2"> <b>City</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($isBreach ? ($address->bcity ?? '') : ($address->pcity ?? '')); ?>" id="bcity">  </div>
				     <div class="col-md-2  text-end"> <b>Pincode: </b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control "  value="<?php echo e($isBreach ? ($address->bpincode ?? '') : ($address->ppincode ?? '')); ?>" id="bpincode">  </div>
				</div>
				<div class="row mb-2 align-items-center">				   
				      <div class="col-md-2"> <b>Breach Clause</b>  </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($address->bclouse ??''); ?>" id="bclouse">  </div>
				     <div class="col-md-2  text-end"> <b>Re-enter Clause: </b> </div>
				    <div class="col-md-3"> <input type="text" class="form-control "  value="<?php echo e($address->breenter ??''); ?>" id="breenter">  </div>
				</div>
				<div class="row mb-2 align-items-center">				   
				      <div class="col-md-2"> <b>Branch Officer:</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($address->bofficer ??  $assignedToUser->name); ?>" id="bofficer" readonly>  </div>
				     <div class="col-md-2  text-end"> <b>Contact Telephone: </b> </div>
				    <div class="col-md-3"> <input type="text" class="form-control "  value="<?php echo e($address->btelephone ??''); ?>" id="btelephone">  </div>
				</div>
				<div class="row mb-1 align-items-center">				   
				    <div class="row mt-2"> <div class="col-md-2">  <b>Remarks: </b> <span class="text-danger">*</span></div>
				    <div class="col-md-9"> <textarea class="form-control" rows="4" id="bremarks"><?php echo e($inspection->bremarks ??''); ?></textarea> </div>
				</div>				
				</div>
				...
				<fieldset class="custom-fieldset">
				  ...
				  <select name="resasonfor" id="resasonfor" class="form-select">				  				 
				   ...
				   <?php $__currentLoopData = getItemsByGroupId(9015); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reasonfor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       		<option value="<?php echo e($reasonfor->id); ?>" <?php echo e(isset($inspection) &&  $inspection->inspection_reason == $reasonfor->id ? 'selected' : ''); ?>><?php echo e($reasonfor->item_name); ?>
				    ...
				    <div class="col-md-3"><input type="text" class="form-control "  value="<?php echo e($comm->main_address->cname ?? ''); ?>" id="cname"> </div>
				    </div>
				<div class="row mb-2 align-items-center">				  
				     <div class="col-md-2 "> <b>House No/Street name</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control " value="<?php echo e($comm->main_address->chouse ?? ''); ?>" id="chouse"></div>
                     <div class="col-md-2 text-end"><b> Locality</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($comm->main_address->clocality  ?? ''); ?>" id="clocality"> </div>
				...
				<div class="row mb-2 align-items-center">
				      ...
				      <div class="col-md-2"> <b>City</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($comm->main_address->ccity  ?? ''); ?>" id="ccity">  </div>
				     <div class="col-md-2  text-end"> <b>Pincode: </b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control "  value="<?php echo e($comm->main_address->cpincode  ?? ''); ?>" id="cpincode">  </div>
				</div>
				<div class="row mb-1 align-items-center">				   
				    <div class="row mt-2"> <div class="col-md-2">  <b>Remarks: </b> <span class="text-danger">*</span></div>
				    <div class="col-md-9"> <textarea class="form-control" rows="4" id="cremarks"><?php echo e($inspection->cremarks ?? ''); ?></textarea> </div>
				</div>
				
				</div>
				
				</fieldset>  
				 <?php if(Auth::user()->sections()->first()->section_code === 'TECH'): ?>
				<fieldset class="custom-fieldset mt-3">
				    <legend> Inspection Details </legend>
				    <div class="row mb-2 align-items-center">
				        <div class="col-md-2"> <b>Inspecting Officer</b> </div>
				        <div class="col-md-3">
				            <input type="text" class="form-control" id="inspection_officer" value="<?php echo e(Auth::user()->name ?? ''); ?>" readonly>
				        </div>
				        ...
				        <div class="col-md-3 ">
				          <input type="date"  class="form-control"  id="inspection_date"
				           value="<?php echo e(!empty($inspection->schedule_date) ? \Carbon\Carbon::parse($inspection->schedule_date)->format('Y-m-d') : ''); ?>">
				           
				        </div>
				    </div>				  
				    <div class="row mb-2 align-items-center">
				        <div class="col-md-2"> <b>Inspection Time From</b> <span class="text-danger">*</span></div>
				        <div class="col-md-3"><input type="time" class="form-control" id="inspection_time_from" value="<?php echo e($inspection->schedule_fromtime ??''); ?>"> </div>
				         <div class="col-md-2 text-end"> <b>Inspection Time To</b> <span class="text-danger">*</span></div>
				        <div class="col-md-3"> <input type="time"  class="form-control" id="inspection_time_to" value="<?php echo e($inspection->schedule_totime ??''); ?>"> </div>
				    </div>
				    <?php if(isset($reschedule) && $reschedule === 'reschedule'): ?>
				  <div class="row mb-2 align-items-center">				  
				     <div class="col-md-2 "> <b>Refused By</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-9"><textarea class="form-control" rows="4" id="refused_by"><?php echo e($inspection->refused_by ?? ''); ?></textarea> </div>                    			
				</div>  <div class="row mb-2 align-items-center">		
				 <div class="col-md-2 "><b> Reason/Remarks</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-9">  <textarea class="form-control" rows="4" id="reason"><?php echo e($inspection->reason ?? ''); ?></textarea>  </div>	</div>
                  <?php endif; ?>				  
			      <div class="row mb-2 align-items-center">	
			       <div class="col-md-5 ">	
            ...
            <input class="form-check-input" type="checkbox"  id="copyAddress"><label class="form-check-label"  for="copyAddress"> Copy Communication Address<small style="color:red;font-size:12px;"> (Check this box if both addresses are the same.)</small></label>
				    ...
				    <div class="col-md-2 text-end"> <b>Name</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"><input type="text" class="form-control "  value="<?php echo e($comm->second_address->pname ??''); ?>" id="pname"> </div>
				    </div>
				<div class="row mb-2 align-items-center">				  
				     <div class="col-md-2 "> <b>House No/Street name</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control " value="<?php echo e($comm->second_address->phouse ??''); ?>" id="phouse"></div>
                     <div class="col-md-2 text-end"><b> Locality</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($comm->second_address->plocality ?? ''); ?>" id="plocality"> </div>				
				</div>

				<div class="row mb-2 align-items-center">				   
				      <div class="col-md-2"> <b>City</b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3">  <input type="text" class="form-control " value="<?php echo e($comm->second_address->pcity ?? ''); ?>" id="pcity">  </div>
				     <div class="col-md-2  text-end"> <b>Pincode: </b> <span class="text-danger">*</span> </div>
				    <div class="col-md-3"> <input type="text" class="form-control "  value="<?php echo e($comm->second_address->ppincode ?? ''); ?>" id="ppincode">  </div>
				</div>
			      <div class="row mb-2 align-items-center">
			        <div class="col-md-2">  <b>Email Address</b> </div>
			        <div class="col-md-3">  <input type="email"  class="form-control" id="inspection_email" placeholder="Enter email address"  value="<?php echo e($comm->second_address->inspection_email ?? ''); ?>" ></div>
			        <div class="col-md-2 text-end">  <b>Phone Number</b>   </div>
			        <div class="col-md-3"> <input type="text"   class="form-control" id="inspection_phone"  placeholder="Enter phone number"  value="<?php echo e($comm->second_address->inspection_phone ?? ''); ?>" >
			        </div>
			    </div>
				</fieldset>	
				<?php endif; ?>	
				...
				<div class="col d-flex mt-3">				
				 <?php if(Auth::user()->sections()->first()->section_code === 'TECH'): ?>
					...
					<?php if(isset($type) && $type == 'breachnotice'): ?>
						...
						<?php else: ?>
					<button type="button" class="btn btn-primary px-4 mt-0 mx-auto" id="submitButton">  <?php echo e(isset($inspection)  ? 'Update' : 'Save'); ?></button>
					<?php endif; ?>
					<?php endif; ?>
				</div>	
				<?php else: ?> 
        ...
        <div class="">  
            <table class="table table-bordered">
                <tr>
                    ...
                    <td>  <input type="text"  class="form-control" id="inspection_officer" value="<?php echo e(Auth::user()->name ?? ''); ?>" readonly> </td>
                      <td>Name of the accompanied Senior Officer</td>                      
                    <td> <select class="form-select"   id="senior_officer">
                          <option value="">Select</option>
    <?php $__currentLoopData = $signingAuthorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($user->id); ?>" <?php echo e((isset($inspectionReportBind) && $inspectionReportBind->senior_officer == $user->id) ? 'selected' : ''); ?>><?php echo e($user->name); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td> <input type="text" id="inspection_date_all" class="form-control" value="<?php echo e(!empty($inspection->schedule_date)  ? \Carbon\Carbon::parse($inspection->schedule_date)->format('d-m-Y')  : 'N/A'); ?>" readonly> </td>
                    <td> <input type="text"  class="form-control numeric-only" id="book_number" value="<?php echo e($inspectionReportBind->book_number ?? ''); ?>"></td>
                    <td><input type="text" class="form-control numeric-only" id="page_number" value="<?php echo e($inspectionReportBind->page_number ?? ''); ?>"></td>
                </tr>
            </table>
            <table class="table table-bordered">
                <tr>  <td>  <label class="form-label">Whether the Construction tallies with the Sanction Plan</label>
                	<select class="form-select" id="construction_tallies"> 
	                        <option value="" >Select</option>
	                       <option value="1" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->construction_tallies === 1 ? 'selected' : ''); ?>>Yes</option> 
	                       <option value="0" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->construction_tallies === 0 ? 'selected' : ''); ?>>No</option>
                        </select>
                </td>
                    <td colspan="2"> 
                    <label class="form-label">Reference number of Sanctioned Plan</label>
                    <input type="text" class="form-control" id="sanction_plan_ref_no" value="<?php echo e($inspectionReportBind->sanction_plan_ref_no ?? ''); ?>">
                    </td>
                </tr>               
                <tr>
                    <td>  <label class="form-label">Date of Sanctioned Plan</label>
                     <input type="date" class="form-control" id="sanction_plan_date" value="<?php echo e(!empty($inspectionReportBind->sanction_plan_date)? \Carbon\Carbon::parse($inspectionReportBind->sanction_plan_date)->format('Y-m-d') : ''); ?>"></td>
                    <td> <label class="form-label">Status of the property</label> 
                    <select class="form-select" id="property_status">
                           <option value="">Select Plot</option>
                   <?php $__currentLoopData = getItemsByGroupId(9001); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		            <option value="<?php echo e($type->id); ?>" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->property_status == $type->id ? 'selected' : ''); ?>><?php echo e($type->item_name); ?></option>
		                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select></td>
                         <td><label class="form-label">If Built up Plot, Number of floors built</label>
                          <input type="text" class="form-control" id="total_floors" value="<?php echo e($inspectionReportBind->total_floors ?? ''); ?>"></td>
                </tr> 
            </table>
    		...
    		<thead>
	    	 ...
	    	 <tbody id="breachTableBody">	    	 
					<?php if(isset($inspectionReportBind) && $inspectionReportBind->breaches->count() > 0): ?>
					    <?php $__currentLoopData = $inspectionReportBind->breaches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $breach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					    <tr class="breachRow" data-changed="0">
					    <td class="srNo" style="font-weight: bold;">1</td>
					        <td>
					        <input type="hidden"  class="row_id  breach_id"  value="<?php echo e($breach->id ?? ''); ?>">
					            <select class="form-select" name="inspected_type[]">
					                <option value="">Select Inspected Type</option>
					                <?php $__currentLoopData = getItemsByGroupId(9010); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                    <option value="<?php echo e($type->id); ?>"  <?php echo e($breach->inspected_type == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?>
					        ...
					        <td>
					            <select class="form-select mb-2" name="breach_type[]">
					                ...
					                <?php $__currentLoopData = getItemsByGroupId(9004); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                    <option value="<?php echo e($type->id); ?>" <?php echo e($breach->breach_type == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?> </option>
					                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					            </select>
					            <select class="form-select mb-2" name="breach_on[]">
					                <option value="">Select Breach on</option>
					                <?php $__currentLoopData = getItemsByGroupId(9005); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                    <option value="<?php echo e($type->id); ?>" <?php echo e($breach->breach_on == $type->id ? 'selected' : ''); ?>>  <?php echo e($type->item_name); ?> </option>
					                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					            </select>
					            <select class="form-select mb-2" name="breach_floor[]">
					                <option value="">Select Floor</option>
					                <?php $__currentLoopData = getItemsByGroupId(9002); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                    <option value="<?php echo e($type->id); ?>" <?php echo e($breach->breach_floor == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?> </option>
					                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					            </select>
					            <select class="form-select  mb-2" name="breach_use[]">
					                <option value="">Select Breach use</option>
					                <?php $__currentLoopData = getItemsByGroupId(1052); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                    <option value="<?php echo e($type->id); ?>" <?php echo e($breach->breach_use == $type->id ? 'selected' : ''); ?>>  <?php echo e($type->item_name); ?> </option>
					                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					            </select>
					        </td>
					        <td>
					            <textarea class="form-control" rows="2" name="location_details[]"><?php echo e($breach->location_details); ?></textarea>
					              <textarea class="form-control mt-2" rows="2" name="location_details_brief[]"><?php echo e($breach->location_details_brief); ?></textarea>
					        </td>
					        <td>
					            <div class="row g-1">
					                <div class="col-md-6">
					                    <input type="text"   class="form-control numeric-decimal" name="length[]" value="<?php echo e($breach->length); ?>">
					                </div>
					                <div class="col-md-6">
	                    <select class="form-select mb-2" name="lunit[]">
	                    <option value="">Select Unit</option>
	                   <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                   <option value="<?php echo e($type->id); ?>" <?php echo e($breach->lunit == $type->id ? 'selected' : ''); ?>><?php echo e($type->item_name); ?></option>
			                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                </select>                       
	                    </div>

					                <div class="col-md-6">
					                    <input type="text" class="form-control numeric-decimal" name="breadth[]"value="<?php echo e($breach->breadth); ?>">
					                </div>
					                <div class="col-md-6">
	                    <select class="form-select mb-2" name="bunit[]">
	                    <option value="">Select Unit</option>
	                   <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                   <option value="<?php echo e($type->id); ?>" <?php echo e($breach->bunit == $type->id ? 'selected' : ''); ?>><?php echo e($type->item_name); ?></option>
			                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                </select>                       
	                    </div>
					                <div class="col-md-6">
					                    <input type="text"  class="form-control numeric-decimal"  name="area[]" value="<?php echo e($breach->area); ?>">
					                </div>
					                <div class="col-md-6">
	                    <select class="form-select mb-2" name="aunit[]">
	                    <option value="">Select Unit</option>
	                   <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                   <option value="<?php echo e($type->id); ?>" <?php echo e($breach->aunit == $type->id ? 'selected' : ''); ?>><?php echo e($type->item_name); ?></option>
			                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                </select>                       
	                    </div>
					            </div>
					        ...
					        <td>
					            ...
					            <select class="form-select" name="objectionable[]">
					                <option value="" <?php echo e($breach->objectionable === null ? 'selected' : ''); ?>>Select</option>
					                <option value="1" <?php echo e($breach->objectionable === 1 ? 'selected' : ''); ?>>   Yes </option>
					                <option value="0" <?php echo e($breach->objectionable === 0 ? 'selected' : ''); ?>> No </option>
					            </select>
					             <textarea class="form-control mt-2" rows="2" name="reason[]"><?php echo e($breach->reason); ?></textarea>
					        </td>
					        <td class="text-center">
					            <button type="button"  class="btn btn-danger btn-sm removeRow"> <i class="fa fa-trash"></i>  </button><br><br>
					                        <button type="button"
        class="btn <?php echo e(!empty($breach->id) ? 'btn-warning' : 'btn-success'); ?> btn-sm saveRow">
    <?php echo e(!empty($breach->id) ? 'Update' : 'Save'); ?>
	            ...
	            <input type="hidden"  class="row_id breach_id" value="<?php echo e($breach->id ?? ''); ?>">
	                <select class="form-select" name="inspected_type[]">
	                    <option value="">Select Inspected Type</option>
	                   <?php $__currentLoopData = getItemsByGroupId(9010); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                   <option value="<?php echo e($type->id); ?>"><?php echo e($type->item_name); ?></option>
			                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	                </select>
	            </td>
	            <td>
	...
	<div class="text-end">
		...
		<table class="table table-bordered" id="unauthorisedTable">
		    ...
		    <tbody id="unauthorisedTableBody">
             <?php if(isset($inspectionReportBind) && $inspectionReportBind->unauthorisedDetails->count() > 0): ?>
              <?php $__currentLoopData = $inspectionReportBind->unauthorisedDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unauthorised): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <tr class="unauthorisedRow"  data-changed="0">
             <td class="srNo" style="font-weight: bold;">1</td>
             <td>
             <input type="hidden"    class="row_id unauthorised_id"    value="<?php echo e($unauthorised->id ?? ''); ?>">
            <select class="form-select" name="unauthorised_inspected_type[]">
                <option value="">Select Inspected Type</option>
                <?php $__currentLoopData = getItemsByGroupId(9010); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type->id); ?>"  <?php echo e($unauthorised->inspected_type == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?> </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </td>
        <td>
            <select class="form-select mb-2" name="floor_breach[]">
                <option value="">Select Floor</option>
                <?php $__currentLoopData = getItemsByGroupId(9002); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type->id); ?>"  <?php echo e($unauthorised->floor_breach == $type->id ? 'selected' : ''); ?>>  <?php echo e($type->item_name); ?>  </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <select class="form-select mb-2" name="floor_breach_use[]">
                <option value="">Select Breach use</option>
                <?php $__currentLoopData = getItemsByGroupId(1052); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($type->id); ?>"  <?php echo e($unauthorised->floor_breach_use == $type->id ? 'selected' : ''); ?>><?php echo e($type->item_name); ?>  </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </td>
        <td>
            <textarea class="form-control"  rows="2"  name="unauthorised_location_details[]"><?php echo e($unauthorised->location_details); ?></textarea>
             <textarea class="form-control mt-2" rows="2" name="unauthorised_location_details_brief[]"><?php echo e($unauthorised->location_details_brief); ?></textarea>
        </td>
        <td>
            <div class="row g-1">
                <div class="col-md-6">
                    <input type="text"  class="form-control numeric-decimal"  placeholder="L"  name="unauthorised_length[]"  value="<?php echo e($unauthorised->length); ?>">
                </div>
                <div class="col-md-6">
                    <select class="form-select mb-2" name="lunit[]">
                        <option value="">Select Unit</option>
                        <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>"    <?php echo e($unauthorised->lunit == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control numeric-decimal"  placeholder="B"    name="unauthorised_breadth[]" value="<?php echo e($unauthorised->breadth); ?>">
                </div>
                ...
                <div class="col-md-6">
                    <select class="form-select mb-2" name="bunit[]">
                        <option value="">Select Unit</option>
                        <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>"   <?php echo e($unauthorised->bunit == $type->id ? 'selected' : ''); ?>>  <?php echo e($type->item_name); ?> </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-6">
                    <input type="text"  class="form-control numeric-decimal"   placeholder="Area" name="unauthorised_area[]"   value="<?php echo e($unauthorised->area); ?>">
                </div>
                ...
                <div class="col-md-6">
                    <select class="form-select mb-2" name="aunit[]">
                        <option value="">Select Unit</option>
                        <?php $__currentLoopData = getItemsByGroupId(1008); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type->id); ?>"   <?php echo e($unauthorised->aunit == $type->id ? 'selected' : ''); ?>> <?php echo e($type->item_name); ?>  </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>

                <div class="col-md-6">
                    WPL: <input type="text"   class="form-control numeric-decimal" name="wpl[]"   value="<?php echo e($unauthorised->wpl); ?>">
                </div>
                <div class="col-md-6">
                    BPL :    <input type="text" class="form-control numeric-decimal"  name="bpl[]"  value="<?php echo e($unauthorised->bpl); ?>">
                </div>
            </div>
        </td>
        <td>
            <select class="form-select" name="objectionable[]">
                 <option value="" <?php echo e($unauthorised->objectionable === null ? 'selected' : ''); ?>>Select</option>
                <option value="1"  <?php echo e($unauthorised->objectionable === 1 ? 'selected' : ''); ?>>   Yes  </option>
                <option value="0" <?php echo e($unauthorised->objectionable === 0 ? 'selected' : ''); ?>>  No </option>
            </select>
             <textarea class="form-control mt-2" rows="2" name="reason[]"> <?php echo e($unauthorised->reason); ?></textarea>
        </td>

        <td class="text-center">
            <button type="button"   class="btn btn-danger btn-sm removeUnauthorisedRow">    <i class="fa fa-trash"></i> </button><br><br>
            <button type="button"
        class="btn <?php echo e(!empty($unauthorised->id) ? 'btn-warning' : 'btn-success'); ?> btn-sm saveRow">
    <?php echo e(!empty($unauthorised->id) ? 'Update' : 'Save'); ?>
    ...
    <?php echo e(!empty($unauthorised->id) ? 'Update' : 'Save'); ?>
		...
		<div class="text-end">
                ...
                <tr>
                    <td>
                        <label class="form-label">The area of plot shown in Lease Deed</label>
                         <input type="text"  class="form-control" id="lease_deed_plot_area"  value="<?php echo e($inspectionReportBind->lease_deed_plot_area ?? ''); ?>">
                    </td>
                    <td >
                       <label class="form-label">Does the plot area in the plan tallies with the area shown in Lease Deed</label>
                        <select class="form-select" id="plot_area_matches">
                            <option value="">Select</option>
                             <option value="1" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->plot_area_matches === 1 ? 'selected' : ''); ?>> Yes </option>
                <option value="0" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->plot_area_matches === 0 ? 'selected' : ''); ?>> No  </option>
                        </select>
                    </td>
                    <td>
                       <label class="form-label">If No, The area of plot shown in plan</label>
                          <input type="text" class="form-control" id="plan_plot_area"   value="<?php echo e($inspectionReportBind->plan_plot_area ?? ''); ?>">
                    </td>
                </tr>
                ...
                <tr> 
                    <td>
                      <label class="form-label">Construction Area</label>
                       <input type="text"  class="form-control" id="construction_area"  value="<?php echo e($inspectionReportBind->construction_area ?? ''); ?>">
                    </td>
                     <td>
                      <label class="form-label"> Whether any tree(s) stand in site (above 18" girth)</label>
                        <select class="form-select" id="tree_exists">
                            <option value="">Select</option>
                               <option value="1"<?php echo e(isset($inspectionReportBind) && $inspectionReportBind->tree_exists === 1 ? 'selected' : ''); ?>>Yes  </option>
                <option value="0" <?php echo e(isset($inspectionReportBind) && $inspectionReportBind->tree_exists === 0 ? 'selected' : ''); ?>>  No </option>
                        </select>
                    </td>
                     <td>
                      <label class="form-label">If yes, indicate number of tree(s)</label>
                       <input type="text"  class="form-control" id="tree_count"  value="<?php echo e($inspectionReportBind->tree_count ?? ''); ?>">
                    </td>
                </tr>
            ...
            <table class="table table-bordered">              
                <tr>
                    <td>Remarks</td>
                    <td> <textarea class="form-control" rows="3" id="remarks"><?php echo e($inspectionReportBind->remarks ?? ''); ?></textarea> </td>
                </tr>
                <tr>                 
    ...
    <option value="">Select</option>
    <?php $__currentLoopData = $signingAuthorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($user->id); ?>" <?php echo e((isset($inspectionReportBind) && $inspectionReportBind->signing_authority == $user->id) ? 'selected' : ''); ?>><?php echo e($user->name); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
           ...
           <div class="text-center mt-4">
			    ...
			    <?php if(isset($inspectionReportBind->inspection_id)): ?>
...
function saveUnauthorisedRow(row)
						    ...
						    $.ajax({
						        url: "<?php echo e(route('inspection.saveUnauthorisedRow')); ?>",
						        type: "POST",
						        data: {
					...
					function saveBreachRow(row)
					{
					    ...
					    $.ajax({
					        url: "<?php echo e(route('inspection.saveBreachRow')); ?>",
					        type: "POST",
					        data: {
					            _token: "<?php echo e(csrf_token()); ?>",
					            inspectionId: $("#inspectionId").val(),
	    ...
	    function setupDynamicTable(
	        ...
	        $(document).on("click", removeButtonClass, function () {
						    ...
						    if (rowId != "") {
						        ...
						        $.ajax({
						            url: "<?php echo e(route('inspection.delete.row')); ?>",
						            type: "POST",
						            data: {
 ...
 <script>
         ...
         function getPropertyBasicDetail(propId, withOutLeaseHold) {               
               $.ajax({
                ...
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    property_id: propId,
                    skipAccessCheck: <?php echo e($skipAccessCheck); ?>,
                    withOutLeaseHold: 0,
                },
	...
	<script>
	    ...
	    $.ajax({
	        type: "GET",
	        url: '<?php echo e(route("getInspectionStatus")); ?>',
	        data: {
...
//			console.log("Step3", $("#refused_by").length);
		if (!isValid) return;
		let saveUrl = "";
		<?php if((isset($schedule) && $schedule === 'schedule') || (isset($reschedule) && $reschedule === 'reschedule')): ?>
		saveUrl = "<?php echo e(route('save.inspection.request')); ?>";
		let formData = { 
			   inspectionId : $("#inspectionId").val(),
			...
			<?php elseif(isset($inspectionreport) && $inspectionreport === 'inspectionreport'): ?>
			     saveUrl = "<?php echo e(route('save.inspection.report')); ?>";	
			...
			<?php elseif(isset($type) && $type === 'breachnotice'): ?>
			 saveUrl = "<?php echo e(route('save.inspection.request')); ?>";    
	   		let formData = {
	        ...
	        success: function (response) {
	            if (response.status == true) {
	               Swal.fire({
					...
					.then(() => {
                    window.location.href =
                        "<?php echo e(route('inspectionlist')); ?>";
                });
	                $("#submitButton")
	                    .html('Save')
	                    .prop('disabled', false);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/inspection/inspectionrequest.blade.php ENDPATH**/ ?>