<?php $__env->startSection('title', 'Application Listing'); ?>
                ...
                <tr>
                    ...
                    <th>
                            <select class="form-control form-select form-select-sm" name="filterByApplication"
                                ...
                                <?php $__currentLoopData = $appTypeItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option class="text-capitalize" value="<?php echo e($item->id); ?>"
                                        <?php if($getApplicationTypeId == $item->id): ?> <?php if(true): echo 'selected'; endif; ?> <?php endif; ?>>
                    ...
                    <th>
                        <select class="form-control form-select form-select-sm" name="status" id="status"
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($item->item_code != 'APP_DES'): ?>
                                    <option class="text-capitalize" value="<?php echo e($item->id); ?>"
                                        <?php if($getStatusId == $item->id): ?> <?php if(true): echo 'selected'; endif; ?> <?php endif; ?>>
                                        <?php echo e($item->item_name); ?>
...
<?php echo $__env->make('include.alerts.application.schedule-meeting-link-application', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript">
    function getFileMovement(applicationNo, button) {
        ...
        $.ajax({
            url: "<?php echo e(route('applications.get.movements')); ?>",
            type: "POST",
            dataType: "JSON",
            data: {
            ...
            success: function(response) {
                ...
                if (response.status === true) {
                    ...
                    let viewMoreUrl = "<?php echo e(route('applications.movements', ['appNo' => '__appNo__'])); ?>";
    ...
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            // responsive: false,
            ajax: {
                 url: "<?php echo e(route('admin.getApplications')); ?>",
                    data: function(d) {
                        d.status = $('#status').val(); // Add selected status to the request
                        d.applicationType =
                            "<?php echo e($applicationType); ?>"; // Add application type to the request
                        d.filterByApplication = $('#filterByApplication')
                            .val(); // Add selected status to the request
                            d.demandType = "<?php echo e($demandType); ?>"; // Add application type to the request
                       }
            },
            columns: [{
                    data: 'id',
    ...
    $('#confirmSendMeetingLink').on('click', function() {
        if (applicationId && applicationNo && applicationModelName) {
            ...
            $.ajax({
                url: "<?php echo e(route('applications.send.appointment.link')); ?>",
                type: 'POST',
                data: {
    ...
    function handleViewApplication(applicationNo,type,applicationId){
        ...
        $.ajax({
                url: "<?php echo e(route('applications.applicationCanView')); ?>",
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    applicationNo: applicationNo
                ...
                success: function(response) {
                    console.log(response);
                    if (response.canView) {
                        // window.location.href = "<?php echo e(url('applications')); ?>" + '/' + applicationId + '?type=' + type;
                         const baseUrl = <?php echo json_encode(route('applications.view', ['id' => '__ID__']), 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/admin/applications/index.blade.php ENDPATH**/ ?>