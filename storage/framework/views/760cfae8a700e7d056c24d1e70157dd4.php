<?php $__env->startSection('title', 'Applicant Property History'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card-body">
            <form method="POST" action="#" enctype="multipart/form-data">
                ...
                <?php if(isset($application)): ?>
                    <input type="hidden" id="updateId" name="updateId" value="<?php echo e($application->id); ?>">
                    <input type="hidden" id="draftApplicationPropertyId" value="<?php echo e($application->old_property_id); ?>">
                <?php else: ?>
                    ...
                    <div class="radio-buttons-0">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(isset($application)): ?>
                                        <input type="text" class="form-control alpha-only" name="propertyid"
                                            id="propertyid" value="<?php echo e($application->old_property_id); ?>" readonly>
                                    <?php else: ?>
                                        ...
                                        <select class="form-select" name="propertyid" id="propertyid">
                                            ...
                                            <?php $__currentLoopData = $userProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($id); ?>">
                                                    <?php echo e($id); ?> (<?php echo e($property['description']); ?>)
                                                </option>
                            ...
                            <div class="col-lg-3 flat-id-group"
                                <?php if(isset($application->flat_id)): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif; ?>>
                                <div class="form-group">
                                    ...
                                    <?php if(isset($application)): ?>
                                        <input type="hidden" class="form-control alpha-only" name="flatid" id="flatid"
                                            value="<?php echo e($application->flat_id); ?>">
                                        <input type="text" class="form-control alpha-only" name="flat_number"
                                            id="flat_number" value="<?php echo e($application->flat_number); ?>" readonly>
                                    <?php else: ?>
                ...
                <div id="stepper3" class="stepper bs-stepper gap-4 vertical FHSubstitutionMutationdiv"
                    ...
                    <div class="bs-stepper-content">
                        <div id="newstep-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.mutation.include.mutation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div id="newstep-vl-2" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.mutation.include.mutation-step-second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div id="newstep-vl-3" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.mutation.include.mutation-step-three', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div id="stepper4" class="stepper bs-stepper gap-4 vertical LHConversiondiv" style="display: none;"
                    ...
                    <div class="bs-stepper-content">
                        <div id="newstep-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.conversion.include.step-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                        ...
                        <div id="newstep-vl-2" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <!-- Conversion 2 -->
                            <?php echo $__env->make('application.conversion.include.step-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                        ...
                        <div id="newstep-vl-3" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <!-- Conversion 3 -->
                            <?php echo $__env->make('application.conversion.include.step-3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                            <div class="row mt-3">
                                <div class="col-lg-6 col-12">
                                    <div class="d-flex align-items-center gap-3">
                ...
                <div id="stepper5" class="stepper bs-stepper gap-4 vertical landusechangeDiv" style="display: none;"
                    ...
                    <div class="bs-stepper-content">
                        <div id="newstep-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.luc.include.step-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                        ...
                        <div id="newstep-vl-2" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.luc.include.step-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- ========== End Land Use Change Div =============== -->
                            <!-- =========== Begin Land Use Change Div ========== -->
                            <?php echo $__env->make('application.luc.include.step-3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- ========== End Land Use Change Div =============== -->
                ...
                <div id="stepper6" class="stepper bs-stepper gap-4 vertical deedofappartmentDiv" style="display: none;"
                    ...
                    <div class="bs-stepper-content">
                        <div id="newstep-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <!-- Land Use Change Step-1 -->
                            <?php echo $__env->make('application.deed_of_apartment.include.step-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                        ...
                        <div id="newstep-vl-2" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.deed_of_apartment.include.step-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div id="stepper7" class="stepper bs-stepper gap-4 vertical nocDiv" style="display: none;"
                    ...
                    <div class="bs-stepper-content">
                        <div id="newstep-vl-1" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <!-- Land Use Change Step-1 -->
                            <?php echo $__env->make('application.noc.include.step-1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End -->
                        ...
                        <div id="newstep-vl-2" role="tabpane3" class="bs-stepper-pane content fade"
                            ...
                            <?php echo $__env->make('application.noc.include.step-2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- ========== End Deed of NOC Div =============== -->
    ...
    <?php echo $__env->make('include.alerts.application.change-property', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('footerScript'); ?>
    ...
    <!-- <script src="<?php echo e(asset('assets/plugins/bs-stepper/js/main.js')); ?>"></script> -->
    
    <script src="<?php echo e(asset('assets/plugins/form-repeater/applicationRepeater.js')); ?>"></script>

    <script>
        var isEditing = "<?php echo e(isset($application) ? true : false); ?>";
        <?php if(isset($application)): ?>
            var application = <?php echo json_encode($application, 15, 512) ?>
        <?php else: ?>
...
<script>
    const fetchUserDetailsUrl = "<?php echo e(route('fetchUserDetails')); ?>";
</script>
    <script src="<?php echo e(asset('assets/js/newApplicant.js')); ?>"></script>
    <script>
    ...
    return sqm * 1.19599;
        ...
        function isPropertyFree(propertyId) {
            return new Promise(function(resolve, reject) {
                $.ajax({
                    url: "<?php echo e(route('isPropertyFree')); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
        ...
        function fetchPropertyDetails(propertyId, draftApplicationPropertyId) {
            ...
            $.ajax({
                url: "<?php echo e(route('appGetPropertyDetails')); ?>",
                type: "POST",
                dataType: "JSON",
                data: {
                    ...
                    propertyId: propertyId,
                    updateId: updateId,
                    model: "<?php echo e(isset($decodedModel) ? $decodedModel : null); ?>",
                    _token: '<?php echo e(csrf_token()); ?>'
                },
                success: function(response) {
                    if (response.status) {
        ...
        $('#confirmApplicationDelete').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('deleteApplication')); ?>",
                type: "POST",
                dataType: "JSON",
                data: {
                    modalId: modalId,
        ...
        function checkAndDeleteRepeater(repeaterElement, identifiers) {
            ...
            var url = (assetType == 'document') ? ("<?php echo e(route('deleteUploadedTempDocument')); ?>") : assetType ==
                'coapplicant' ? "<?php echo e(route('deleteTempCoapplicant')); ?>" : '';
            console.log(url)
            $.ajax({
                type: "POST",
                url: url,
        ...
        document.getElementById('propertyid').addEventListener('change', function() {
            ...
            var userProperties = <?php echo json_encode($userProperties, 15, 512) ?>;
        ...
        $('#flatid').on('change', function() {
            ...
            if (flatId != '') {
                $.ajax({
                    url: "<?php echo e(route('appGetFlatDetails')); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        flatId: flatId,
        ...
        function deleteValuesForUncheckedDocument(id,updatedId) {
            if (id != '') {
                $.ajax({
                    url: "<?php echo e(route('applicant.deleteValuesForUncheckedDocument')); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        id: id,
    ...
    <script src="<?php echo e(asset('assets/js/newApplicantStepper.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/imgPreview.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/frontend/assets/js/crypto-js.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/frontend/assets/js/commonFunctions.js')); ?>"></script>
    <script>
        ...
        $("#applicationType").change(function() {
            ...
            let statusDropdownValue = <?php echo json_encode((string) ($application->status_of_applicant ?? '')); ?>;
        ...
        $('#statusofapplicant').on('change', function() {
            ...
            if (appTempId != 0) {
                ...
                $.ajax({
                    url: "<?php echo e(route('updateApllicantStatus')); ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        appTempId: appTempId,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/applicant/new_application.blade.php ENDPATH**/ ?>