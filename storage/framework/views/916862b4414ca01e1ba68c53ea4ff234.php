...
<div class="card">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a href="<?php echo e(route('litigation.create')); ?>"
...
<script>
    ...
    $(document).ready(function () {
        let table = $('#litigationTable').DataTable({
            ...
            order: [[1, 'desc']],
            ajax: {
                url: "<?php echo e(route('get.litigations')); ?>",
                data: function (d) {
        ...
        $('#resetBtn').on('click', function () {
         ...
         let deleteLitigationId;
        let deleteModal;

        $(document).on('click', '.delete-litigation', function () {
            deleteLitigationId = $(this).data('id');
        ...
        $('#confirmDelete').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('litigation.destroy', ':id')); ?>".replace(':id', deleteLitigationId),
                type: 'DELETE',
                data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/litigation/indexDatatable.blade.php ENDPATH**/ ?>