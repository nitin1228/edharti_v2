...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12">
                <form id="filter-form" method="get" action="<?php echo e(route('detailedReport')); ?>">
                        ...
                        <div class="d-flex align-items-start w-btn-full flex-wrap" style="margin-left:-0.5rem">
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker" aria-label="Land" aria-placeholder="Land" data-live-search="true" title="Land" id="land-type" name="landType">
                                    ...
                                    <option value="<?php echo e($landType->id); ?>" <?php echo e((isset($filters['landType'] ) && $landType->id==$filters['landType'] ) ? 'selected':''); ?>><?php echo e($landType->item_name); ?></option>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker propType multipleSelect" multiple aria-label="Land Use Type" data-live-search="true" title="Land Use Type" id="property-Type" name="property_type[]">
                                    ...
                                    <option value="<?php echo e($propertyType->id); ?>" <?php echo e((isset($filters['property_type'] ) && in_array($propertyType->id,$filters['property_type'] )) ? 'selected':''); ?>><?php echo e($propertyType->item_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker propSubType multipleSelect" multiple aria-label="Land Use Sub-Type" data-live-search="true" title="Land Use Sub-Type" id="prop-sub-type" name="property_sub_type[]">
                                    <option value="">All</option>
                                    <?php $__currentLoopData = $propertySubtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($st->id); ?>" <?php echo e((isset($filters['property_sub_type'] ) && in_array($st->id,$filters['property_sub_type'] )) ? 'selected':''); ?>><?php echo e($st->item_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker multipleSelect" multiple aria-label="Land Status" data-live-search="true" title="Land Status" id="land-status" name="property_status[]">
                                    <option value="">All</option>
                                    <?php $__currentLoopData = $propertyStatus[0]->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status->id); ?>" <?php echo e((isset($filters['property_status'] ) && in_array($status->id,$filters['property_status'] )) ? 'selected':''); ?>><?php echo e($status->item_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker colony" multiple aria-label="Search by Colony" data-live-search="true" title="Colony" id="colony_filter" name="colony[]">
                                    ...
                                    <option value="<?php echo e($colony->id); ?>" <?php echo e((isset($filters['colony'] ) && in_array($colony->id,$filters['colony'] )) ? 'selected':''); ?>><?php echo e($colony->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker" multiple aria-label="Search by Lease Deed" data-live-search="true" title="Lease Deed" id="leaseDeed_filter" name="leaseDeed[]">
                                    <option value="">All</option>
                                    <?php $__currentLoopData = $leaseTypes[0]->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leaseType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($leaseType->id); ?>" <?php echo e((isset($filters['leaseDeed'] ) && in_array($leaseType->id, $filters['leaseDeed'] )) ? 'selected':''); ?>><?php echo e($leaseType->item_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            ...
                            <div class="relative-input mb-3 ms-2">
                                <select class="selectpicker" multiple aria-label="Search by section" data-live-search="true" title="Section" id="section_filter" name="section_id[]">
                                    ...
                                    <option value="<?php echo e($section->id); ?>" <?php echo e((isset($filters['section_id'] ) && in_array($section->id, $filters['section_id'] )) ? 'selected':''); ?>><?= $section->name ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                ...
                <div class="table-responsive mt-2">
                    <table id="example" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($loop->iteration + $startNum); ?></td>
                                <td><?php echo e($prop->unique_propert_id); ?> <br> <?php echo e(' ('.$prop->old_propert_id.')'); ?></td>
                                <td><?php echo e($prop->address); ?></td>
                                
                                <td><?php echo e($prop->landType); ?></td>
                                <td><?php echo e($prop->propertyStatus); ?></td>
                                <td><?php echo e($prop-> latestPropertyType ?? $prop->propertyType); ?></td>
                                <td><?php echo e($prop->latestPropertySubType ?? $prop->propertySubtype); ?></td>
                                
                                <td><?php echo e(round($prop->area_in_sqm,2)); ?></td>
                                
                                
                                <td><?php echo e(date('d-m-Y', strtotime($prop->doe))); ?></td>
                                <td><?php echo e((!is_null($prop->current_lesse_name) && $prop->current_lesse_name !="") ? $prop->current_lesse_name :  'NA'); ?></td>
                                <td><?php echo e(!is_null($prop->transferDate) ? date('d-m-Y', strtotime($prop->transferDate)) : ''); ?></td>
                                <td><?php echo e($prop->child_prop_id ?? 'No'); ?></td>
                                <td>
                                    <span class="location_icon" data-bs-toggle="modal" data-bs-target="#viewMapModal" onclick="locate('<?php echo e($prop->old_propert_id); ?>')"><i class="lni lni-map-marker text-danger" data-toggle="tooltip" title="View Mapview"></i></span><a href="/streetview/<?php echo e($prop->old_propert_id); ?>" target="_blank" data-toggle="tooltip" title="View Streetview"><span class="location_icon"> <img src="<?php echo e(asset('assets/images/street-view.svg')); ?>" class="map-marker-icon" /> </span></a>
                                    <a href="<?php echo e(route('viewPropertyDetails',$prop->id)); ?>" class="btn btn-primary" target="_blank">View More</a>
                                </td>
                            </tr>
                ...
                <div class="row mt-2">
                    ...
                    ?>
                    <div class="col-lg-6">Total <?php echo e($total); ?> <?php echo e($total != 1 ? 'proeperties': 'proeperty'); ?> found</div>
                    <div class="col-lg-6">

                        <div style="float: right;"><?php echo e($properties->appends(request()->input())->links()); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo $__env->make('modals.map', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <a href="<?php echo e(route('map')); ?>" class="btn btn-primary" target="_blank">View All Properties</a>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('assets/js/property-type-subtype-dropdown.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/map.js')); ?>"></script>
<!-- use version 0.20.3 -->
<script lang="javascript" src="<?php echo e(asset('assets/js/xlsx.full.min.js')); ?>"></script>
<script>
    const wsData = [];
    ...
    function fetchPage(page, data) {
        ...
        $.ajax({
            type: "get",
            url: '<?php echo e(route("detailedReportExport")); ?>',
            data: data,
            success: response => {
    ...
    function appendToexcel(item) {
        ...
        wsData.push(
            [item.unique_propert_id ?? '',
                ...
                item.transferDate ? displayDateTime(item.transferDate) : '',
    ...
    function resetFilters() {
        ...
        window.location.href = "<?php echo e(route('detailedReport')); ?>";
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/report/detailed-report.blade.php ENDPATH**/ ?>