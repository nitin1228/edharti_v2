         ...
         <div class="modal-dialog modal-dialog-centered modal-xl">
             <div class="modal-content">
                 ...
                 <div class="modal-footer">
                     <div class="d-flex">
                         <button onclick="saveAsPdf()" class="btn btn-primary" id="btn-pdf" <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('create.rgr.draft' )): ?> style="display: none;" <?php endif; ?>>Generate pdf</button>
                     </div>
     ...
     <script>
         ...
         function viewDraft(id) {
             rgrId = id;
             let url = "<?php echo e(route('viewDraft', ['rgrId' => '__ID__'])); ?>".replace('__ID__', rgrId);
         ...
         function saveAsPdf() {
            let url = "<?php echo e(route('saveAsPdf', ['id' => '__ID__'])); ?>".replace('__ID__', rgrId);
             $.ajax({
                 type: "get",
                 url: url,
     ...
     </script><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/modals/view-rgr-draft.blade.php ENDPATH**/ ?>