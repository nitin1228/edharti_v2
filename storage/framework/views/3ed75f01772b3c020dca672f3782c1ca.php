    ...
    <div class="modal-dialog">
        <div class="modal-content text-center">
            ...
            <div class="modal-body">
                <img src="<?php echo e(asset('assets/images/warning.svg')); ?>" alt="warning" class="warning_icon">
...
<?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/include/alerts/delete-confirmation.blade.php ENDPATH**/ ?>