...
<style>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="part-details">
                            <div class="container-fluid">
                                <?php if($user->userProperties): ?>
                                    <?php $__currentLoopData = $user->userProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="row">
                                            <div class="col-lg-12 col-12">
                                                <h5 class="text-primary">PROPERTY ID : <?php echo e($property->old_property_id ?? ''); ?></h5>
                                                
                                                <table class="table table-bordered property-table-info">
                                                    <tbody>
                                                        <tr>
                                                            <th>Property ID :</th>
                                                            <td><?php echo e($property->old_property_id ?? ''); ?></td>
                                                        ...
                                                        <tr>
                                                            <th>Locality :</th>
                                                            <td>
                                                                <?php echo e($property->oldColony->name ?? ''); ?>

                                                            </td>
                                                            <th>Block :</th>
                                                            <td><?php echo e($property->block ?? ''); ?></td>


                                                        </tr>
                                                        <tr>
                                                            <th>Plot :</th>
                                                            <td><?php echo e($property->plot ?? ''); ?></td>
                                                            <th>Known As :</th>
                                                            <td><?php echo e($property->known_as ?? ''); ?></td>

                                                        </tr>
                                                        <?php if(!empty($property->flat->id)): ?>
                                                            <tr>
                                                                <th>Flat Id :</th>
                                                                <td><?php echo e($property->flat->unique_flat_id ?? ''); ?></td>
                                                                <th>Flat Number :</th>
                                                                <td><?php echo e($property->flat->flat_number ?? ''); ?></td>
                                                            </tr>
                                                        <?php endif; ?>
                                                        <tr>
                                                            <th>Documents :</th>
                                                            <td colspan="3">
                                                                <?php if($property->documents->isNotEmpty()): ?>
                                                                    <span class="view-hover-data show-toggle-data ms-2"
                                                                        ...
                                                                        <div class="tooltip-data" style="left: 15px; min-width:250px;width:fit-content;max-width:350px;padding-bottom:25px;">
                                                                            <?php $__currentLoopData = $property->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php
                                                                                ...
                                                                                <span class='td-data-link'><i
                                                                                        ...
                                                                                        href='<?php echo e(asset('storage/' . $document->file_path ?? '#')); ?>'
                                                                                        target='_blank'
                                                                                        class='link-primary'><?php echo e($document->title); ?></a></span>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="part-details">
                            <div class="container-fluid">
                                <?php if($newProperties): ?>
                                    <?php $__currentLoopData = $newProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newProperty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="row">
                                            <div class="col-lg-12 col-12">
                                                <h5 class="text-primary">PROPERTY ID : <?php echo e($newProperty->old_property_id ?? 'The process for generating the property ID is currently underway.'); ?>
                                                ...
                                                <table class="table table-bordered property-table-info">
                                                    <tbody>
                                                        <tr>
                                                            <th>Property ID :</th>
                                                            <td><?php echo e($newProperty->old_property_id ?? 'Under Process'); ?></td>
                                                            <th>Current Status:</th>
                                                            <td>
                                                                <?php switch(getStatusDetailsById( $newProperty->status ?? '' )->item_code):
                                                                    case ('RS_REJ'): ?>
                                                                        <div
                                                                            class="ml-2 badge rounded-pill text-danger bg-light-danger p-2 text-uppercase px-3">
                                                                            <?php echo e(getStatusDetailsById($newProperty->status ?? '')->item_name); ?>
                                                        ...
                                                        <tr>
                                                            <th>Locality :</th>
                                                            <td>
                                                                <?php echo e($newProperty->oldColony?->name ?? ($newProperty->locality_name ?? '')); ?>

                                                            </td>
                                                            <th>Block :</th>
                                                            <td><?php echo e($newProperty->block ?? ''); ?></td>


                                                        </tr>
                                                        <tr>
                                                            <th>Plot :</th>
                                                            <td><?php echo e($newProperty->plot ?? ''); ?></td>
                                                            <th>Known As :</th>
                                                            <td><?php echo e($newProperty->known_as ?? $newProperty->block . '/' . $newProperty->plot . '/' . $newProperty->oldColony->name); ?>

                                                            </td>

                                                        </tr>
                                                        <?php if(!empty($newProperty->is_property_flat)): ?>
                                                            <?php if(!empty($newProperty->flat->unique_property_id)): ?>
                                                                <tr>
                                                                    <th>Flat Id :</th>
                                                                    <td><?php echo e($newProperty->flat->unique_property_id ?? ''); ?></td>
                                                                    <th>Flat Number :</th>
                                                                    <td><?php echo e($newProperty->flat->flat_number ?? ''); ?></td>
                                                                </tr>
                                                            <?php else: ?>
                                                                <tr>
                                                                    <th>Flat Number :</th>
                                                                    <td colspan="3"><?php echo e($newProperty->flat_no ?? ''); ?></td>
                                                                </tr>    
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                        <tr>
                    ...
                    <div class="tab-pane fade" id="pills-rejected" role="tabpanel" aria-labelledby="pills-rejected-tab">
                        <div class="part-details">
                            <div class="container-fluid">
                                <?php if($rejectedProperties): ?>
                                    <?php $__currentLoopData = $rejectedProperties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newProperty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="row">
                                            <div class="col-lg-12 col-12">
                                                <h5 class="text-primary">PROPERTY ID : <?php echo e($newProperty->old_property_id ?? 'The process for generating the property ID is currently underway.'); ?>
            ...
            <div class="part-details" id="newPropertyForm" style="display: <?php echo e($errors->any() ? 'block' : 'none'); ?>;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <form action="<?php echo e(route('applicant.properties.store')); ?>" method="POST"
                                enctype="multipart/form-data" id="addNewPropertyForm">
                                <?php echo csrf_field(); ?>
                                <div id="propertyownerDiv">
                                    <div class="row g-3">
                                        <div class="form-group col-md-4">
                                            <select name="landTypeInv" id="landTypeInv" class="form-select">
                                                <option value="">Select Land Type</option>
                                                <?php $__currentLoopData = $landTypes[0]->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $landType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($landType->id); ?>">
                                                        <?php echo e($landType->item_name); ?>

                                                    </option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <div id="landTypeInvError" class="text-danger text-left"></div>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="row g-3" style="padding-top: 19px; display:none;" id="flatDivInv">
                                        <div class="form-group col-md-4">
                                            <div class="form-check">
                                                <input type="checkbox" name="isPropertyFlat" value="1"
                                                    class="form-check-input" id="isPropertyFlat"
                                                    <?php echo e(old('isPropertyFlat') ? 'checked' : ''); ?>>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                <select name="localityInv" id="locality" class="form-select">
                                                    ...
                                                    <?php $__currentLoopData = $colonyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colony): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($colony->id); ?>"
                                                            <?php echo e(old('localityInv') == $colony->id ? 'selected' : ''); ?>>
                                                            <?php echo e($colony->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            ...
                                            <div class="col-md-4 isPropertyDetailsNotFoundUnChecked"
                                                ...
                                                <input style="margin-top:6px;" type="checkbox" name="isFlatNotInList"
                                                    ...
                                                    <?php echo e(old('isFlatNotInList') ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-group mt-4">
                                        <div class="form-check">
                                            <input type="checkbox" name="propertyId" value="1"
                                                ...
                                                <?php echo e(old('propertyId') ? 'checked' : ''); ?>>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="blocknoInvFill" id="blocknoInvFill"
                                                    ...
                                                    value="<?php echo e(old('blocknoInvFill')); ?>">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="plotnoInvFill" id="plotnoInvFill"
                                                    ...
                                                    value="<?php echo e(old('plotnoInvFill')); ?>">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="knownasInvFill" id="knownasInvFill"
                                                    ...
                                                    value="<?php echo e(old('knownasInvFill')); ?>">
                                                ...
                                                <select name="landUseInvFill" id="landUseInvFill"
                                                    ...
                                                    <?php $__currentLoopData = $propertyTypes[0]->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($propertyType->id); ?>"
                                                            <?php echo e(old('landUseInvFill') == $propertyType->id ? 'selected' : ''); ?>>
                                                            <?php echo e($propertyType->item_name); ?>
    ...
    <script>
        ...
        $('#locality').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('landTypes')); ?>",
                        type: "POST",
                        data: {
                            locality: locality,
                            _token: '<?php echo e(csrf_token()); ?>'
        ...
        $('#landUse').on('change', function() {
            ...
            $("#landUseSubtype").html('<option value="">Select</option>');
                    $.ajax({
                        url: "<?php echo e(route('landSubTypes')); ?>",
                        type: "POST",
                        data: {
                            locality: locality,
                            landType: landType,
        ...
        $('#plot').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#flat").html('');
                    $.ajax({
                        url: "<?php echo e(route('knownAsFlat')); ?>",
                        type: "POST",
                        data: {
                            locality: locality,
                            block: block,
        ...
        $('#flat').on('change', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('getFlatDetails')); ?>",
                type: "POST",
                data: {
                    flatId: flatId,
                    _token: '<?php echo e(csrf_token()); ?>'
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const landTypeSelect = document.getElementById('landTypeInv');
            const flatDiv = document.getElementById('flatDivInv');

            // Check on page load
            toggleFlatDiv();

            // Add event listener for change event
            landTypeSelect.addEventListener('change', toggleFlatDiv);

            function toggleFlatDiv() {
                const selectedOption = landTypeSelect.options[landTypeSelect.selectedIndex];

                if (selectedOption.textContent.trim() === 'Nazul') {
                    flatDiv.style.display = 'flex'; // or 'flex', 'grid', etc. depending on your layout
                } else {
                    flatDiv.style.display = 'none';

                    // Reset flat dropdown
                    $('#flat').val('').prop('selectedIndex', 0);
                    // Clear flat number input
                    $('#flat_no_rec_not_found').val('');
                    $('#flat_no').val('');

                    // Uncheck both checkboxes
                    $('#isPropertyFlat').prop('checked', false).val('0');
                    $('#isFlatNotInList').prop('checked', false);

                    // Trigger change event on main checkbox
                    $('#isPropertyFlat').trigger('change');
                }
            }
        });
    </script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WORK\Laravel\Development Server\edharti_v2\resources\views/applicant/property.blade.php ENDPATH**/ ?>