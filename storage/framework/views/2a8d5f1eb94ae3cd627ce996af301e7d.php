    ...
    <div class="col-lg-12">
        <div id="repeater" class="position-relative">
            ...
            <div class="duplicate-field-tab">
                <?php if(isset($tempCoapplicant) && count($tempCoapplicant) > 0): ?>
                    <?php $__currentLoopData = $tempCoapplicant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="items coapplicant-block" data-group="coapplicant" data-type='coapplicant'>
                            <!-- Repeater Content -->
                            <input type="hidden" data-name="coapplicantId" value="<?php echo e($tc->id); ?>">
                            <input type="hidden" data-name="indexNo" value="<?php echo e($tc->index_no ?? $loop->iteration); ?>">
                            <!-- Repeater Content -->
                            <div class="item-content mb-2">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="testname" class="form-control alpha-only"
                                                ...
                                                value="<?php echo e($tc->co_applicant_name); ?>">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="gender" id="gender"
                                                ...
                                                <option value="Male"
                                                    <?php echo e($tc->co_applicant_gender == 'Male' ? 'selected' : ''); ?>>Male
                                                </option>
                                                <option value="Female"
                                                    <?php echo e($tc->co_applicant_gender == 'Female' ? 'selected' : ''); ?>>Female
                                                </option>
                                                <option value="Transgender"
                                                    <?php echo e($tc->co_applicant_gender == 'Transgender' ? 'selected' : ''); ?>>Transgender
                                                </option>
                                            </select>
                                            <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                            <span class="error-message text-danger"></span>
                                            ...
                                            <div class="row merge-inputs">
                                                <div class="col-lg-6">
                                                    <input type="date" id="dateOfBirth" name="dateOfBirth"
                                                        value="<?php echo e($tc->co_applicant_age); ?>" data-name="dateOfBirth"
                                                        class="form-control">
                                                    <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                                    <span class="error-message text-danger"></span>
                                                </div>
                                    ...
                                    <input type="text" name="age" class="form-control numericOnly" id="age"
                                        ...
                                        value="<?php echo e($tc->co_applicant_age); ?>">
                                </div> -->
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="row merge-inputs">
                                                <div class="col-lg-6">
                                                    <select name="prefixInv" data-name="prefixInv" id="prefix"
                                                        ...
                                                        <option value="S/o"
                                                            <?php echo e($tc->prefix == 'S/o' ? 'selected' : ''); ?>>S/o</option>
                                                        <option value="D/o"
                                                            <?php echo e($tc->prefix == 'D/o' ? 'selected' : ''); ?>>D/o</option>
                                                        <option value="Spouse Of"
                                                            <?php echo e($tc->prefix == 'Spouse Of' ? 'selected' : ''); ?>>Spouse
                                                            Of</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">
                                                    <input type="text" name="secondnameInv"
                                                        value="<?php echo e($tc->co_applicant_father_name); ?>"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="aadhar" class="form-control numericOnly"
                                                ...
                                                data-name="aadharnumber" value="<?php echo e(decryptString($tc->co_applicant_aadhar)); ?>">
                                            <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                            <span class="error-message text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="coapplicant[0][aadhaarFile]"
                                                ...
                                                data-should-validate = "<?php echo e(isset($tc) && $tc->aadhaar_file_path != ''); ?>"
                                                <?php if($isEditDisabled): ?> disabled <?php endif; ?>>
                                            <?php if(isset($tc->aadhaar_file_path)): ?>
                                                <a href="<?php echo e(asset('storage/' . $tc->aadhaar_file_path ?? '')); ?>"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pan"
                                                ...
                                                value="<?php echo e($tc->co_applicant_pan); ?>">
                                            <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                            <span class="error-message text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="coapplicant[0][panFile]" class="form-control"
                                                ...
                                                data-should-validate = "<?php echo e(isset($tc) && $tc->pan_file_path != ''); ?>"
                                                <?php if($isEditDisabled): ?> disabled <?php endif; ?>>
                                            <?php if(isset($tc->pan_file_path)): ?>
                                                <a href="<?php echo e(asset('storage/' . $tc->pan_file_path ?? '')); ?>"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobilenumber"
                                                ...
                                                value="<?php echo e($tc->co_applicant_mobile); ?>">
                                            <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                            <span class="error-message text-danger"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 d-flex justify-content-between" id="coapplicant_0">
                                        <div class="form-group form-box">
                                            ...
                                            <input type="file" name="coapplicant[0][photo]" class="form-control"
                                                ...
                                                data-should-validate = "<?php echo e(isset($tc->image_path) && $tc->image_path != ''); ?>"
                                                <?php if($isEditDisabled): ?> disabled <?php endif; ?>>
                                            <!-- add error span tag by anil on 03-04-2025 for show error in draft view-->
                                            <span class="error-message text-danger"></span>
                                        </div>
                                        <div class="preview_img">
                                            ...
                                            <?php if(isset($tc->image_path) && $tc->image_path): ?>
                                                <img class="preview" alt="Photo Preview"
                                                    src="<?php echo e(asset('storage/' . $tc->image_path)); ?>"
                                                    style="display: block;" />
                                            <?php else: ?>
                                                <img class="preview" alt="Photo Preview" />
                                            <?php endif; ?>
                            ...
                            <div class="repeater-remove-btn">
                                <button type="button" class="btn btn-danger remove-btn px-4" data-toggle="tooltip"
                                    ...
                                    <?php if($isEditDisabled): ?> not-deletable="ture" <?php endif; ?>>
...
<!-- row end -->
<?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/application/mutation/include/coapplicant.blade.php ENDPATH**/ ?>