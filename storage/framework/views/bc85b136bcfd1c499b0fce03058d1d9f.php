<?php $__env->startSection('title', 'Calculate RGR'); ?>
...
<div class="card">
            ...
            <?php endif; ?> -->
                <div class="col">
                    <table class="table table-bordered table-info table-top RGR_table_design">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo e(customNumFormat($totalLeaseHoldCount)); ?> <small style="display: block; font-size: small;">(Only residential and commercial properties)</small></td>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/rgr/dashboard.blade.php ENDPATH**/ ?>