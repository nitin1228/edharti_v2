...
<body>
    <div class="error-wrap">
        <h1>404</h1>
        <div class="error-msg">
            <img src="<?php echo e(asset('assets/images/close-error.svg')); ?>" alt="Error Page"/>
            <p>REQUESTED PAGE NOT FOUND!</p>
            <div class="think-cloud">
                
                <img src="<?php echo e(asset('assets/images/cloud-think.png')); ?>" alt="Think Cloud"/>
            </div>
        </div>
        <div class="error-foot">
            ...
            <a class="action-btn" href="<?php echo e(route('login')); ?>"> <img src="<?php echo e(asset('assets/images/arrow_back.svg')); ?>" alt="Back arrow"/> Back </a>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\WORK\Laravel\Development Server\edharti_v2\resources\views/errors/404.blade.php ENDPATH**/ ?>