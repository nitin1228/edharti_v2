                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="gender" id="gender" data-name="gender">
                                            ...
                                            <option value="Male"
                                                <?php echo e($coapplicant->co_applicant_gender == 'Male' ? 'selected' : ''); ?>>Male
                                            </option>
                                            <option value="Female"
                                        ...
                                        <div class="row merge-inputs">
                                            <div class="col-lg-6">
                                                <input type="date" id="dateOfBirth" name="dateOfBirth"
                                                    value="<?php echo e($coapplicant->co_applicant_age); ?>" data-name="dateOfBirth"
                                                    class="form-control">
                                                <span class="error-message text-danger"></span>
                                        ...
                                        <div class="row merge-inputs">
                                            <div class="col-lg-6">
                                                <select name="conPrefixInv" data-name="conPrefixInv" id="prefix"
                                                    ...
                                                    <option value="S/o"
                                                        <?php echo e($coapplicant->prefix == 'S/o' ? 'selected' : ''); ?>>S/o
                                                    </option>
                                                    <option value="D/o"
                                                        <?php echo e($coapplicant->prefix == 'D/o' ? 'selected' : ''); ?>>D/o
                                                    </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="aadhar" class="form-control numericOnly"
                                            ...
                                            data-name="aadharnumber" value="<?php echo e(decryptString($coapplicant->co_applicant_aadhar)); ?>">
                                        <span class="error-message text-danger"></span>
                                    </div>
                                </div>
                                <!-- ------------------------ -->
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobilenumber" class="form-control numericOnly"
                                            ...
                                            data-name="mobilenumber" value="<?php echo e($coapplicant->co_applicant_mobile); ?>">
                                        <span class="error-message text-danger"></span>
                                    </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/application/noc/include/coapplicant.blade.php ENDPATH**/ ?>