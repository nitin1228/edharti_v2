                    ...
                    <div class="col mt-2 mb-2" id="demand-subheads-container">
                      ...
                      <div class="demand-item-container">
                        ...
                        <div class="col-lg-12 my-3" id="calculation-div">
                          <button type="button" class="btn btn-sm btn-primary btn-calculate me-auto" style="display: none"><?php echo e(($head->item_code == "DEM_PENAL_STANDARD" || $head->item_code == "DEM_OTHER")?'Add':'Calculate'); ?></button>
                        </div>
                        <?php endif; ?>
                      </div>
                      <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\edhartiMain\resources\views/demand/input-form.blade.php ENDPATH**/ ?>