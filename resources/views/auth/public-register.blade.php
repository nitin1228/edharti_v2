                                ...
                                <div class="row less-padding-input" id="addressDetails">
                                    ...
                                    <div id="ifYesNotChecked" class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-12">
                                                <div class="form-group">
                                                    <label for="landTypeInv" class="quesLabel">Land Type <span
                                                            class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-12">
                                        <!-- Flat Code Comment on 08/01/2026 By Lalit as per discuss with Kunal Sir -->
                                        <div class="mix-field" style="margin-bottom: 10px; display:none;" id="flatDivInv">
                                        ...
                                        <div class="ifyes internal_container my-3" id="ifyes" style="display: none;">
                                            <div class="row less-padding-input">
                                                ...
                                                <div class="col-lg-3 col-12">
                                                    <div class="form-group">
                                                        <label for="landTypeInvFill" class="quesLabel">Land Type <span
                                                                class="text-danger">*</span></label>
                                                        <select name="landTypeInvFill" id="landTypeInvFill"
                                                            class="form-select">
                                                            <option value="">Select</option>
                                                            @foreach ($landTypes[0]->items as $landType)
                                                                <option value="{{ $landType->id }}">
                                                        ...
                                                        <div id="landTypeInvFillError" class="text-danger text-left">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group form-box">
                                            <label for="OrgName" class="quesLabel">Organization Name<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="nameOrg" class="form-control alphanumericorgname"
                                ...
                                <div class="row" id="OrgAddressDetails">
                                    ...
                                    <div class="col-lg-12">
                                        <div id="ifYesNotCheckedOrg" class="row child_columns">
                                            ...
                                            <div class="col-lg-3 col-12">
                                                <div class="form-group">
                                                    <label for="landTypeOrg" class="quesLabel">Land Type <span
                                                            class="text-danger">*</span></label>
                                                    <select name="landTypeOrg" id="landTypeOrg" class="form-select">
                                                        <option value="">Select</option>
                                                        @foreach ($landTypes[0]->items as $landType)
                                                            <option value="{{ $landType->id }}">
                                                                {{ $landType->item_name }}
                                                    ...
                                                    <div id="landTypeOrgError" class="text-danger text-left"></div>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group form-box">
                                            <!-- Flat Code Comment on 08/01/2026 By Lalit as per discuss with Kunal Sir -->
                                            <div class="mix-field" style="margin-bottom: 10px; display:none;" id="flatDivOrg">
                                                <label for="propertyId_property" class="quesLabel">Is Property in a Multistorey Building?</label>
                                                <div class="radio-options ml-5">
                                            ...
                                            <div class="ifyes internal_container my-3" id="ifyesOrg"
                                                ...
                                                <div class="row less-padding-input">
                                                    ...
                                                    <div class="col-lg-3 col-12">
                                                        <div class="form-group">
                                                            <label for="landTypeOrgFill" class="quesLabel">Land Type
                                                                <span class="text-danger">*</span></label>
                                                            <select name="landTypeOrgFill" id="landTypeOrgFill"
                                                                class="form-select">
                                                                <option value="">Select</option>
                                                                @foreach ($landTypes[0]->items as $landType)
                                                                    <option value="{{ $landType->id }}">
                                                            ...
                                                            <div id="landTypeOrgFillError"
                                                                class="text-danger text-left">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-4 col-12 isPropertyDetailsNotFoundCheckedOrg"
                                                        style="display: none;" id="flatNoOrgDivAfterCheckedAddressNotFound">
                                                        <div class="form-group form-box">
 ...
 <script>
  ...
  $('#refreshCaptcha').on('click', function() {
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#Yes').change(function() {
                if ($(this).is(':checked')) {
                    ...
                    // Reset Land Type Inv dropdown
                    $('#landTypeInv').val('').prop('selectedIndex', 0);
                    $('#isPropertyFlat').prop('checked', false);
            ...
            $('#YesOrg').change(function() {
                if ($(this).is(':checked')) {
                    ...
                    // Reset Land Type Inv dropdown
                    $('#landTypeOrg').val('').prop('selectedIndex', 0);
                    $('#isPropertyFlatOrg').prop('checked', false);
                    $('#isPropertyFlatOrg').trigger('change');
                    const flatDiv = document.getElementById('flatDivOrg');
                    flatDiv.style.display = 'none';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const landTypeSelect = document.getElementById('landTypeOrg');
            const flatDiv = document.getElementById('flatDivOrg');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleFlatDiv() {
                ...
                if (selectedOption.textContent.trim() === 'Nazul') {
                    ...
                    // Reset flat dropdown
                    $('#flatOrg').val('').prop('selectedIndex', 0);

                    // Clear flat number input
                    $('#flat_no_org').val('');

                    // Clear flat number input
                    $('#flat_no_org_rec_not_found').val('');


                    // Uncheck both checkboxes
                    $('#isPropertyFlatOrg').prop('checked', false).val('0');
                    $('#isFlatNotInListOrg').prop('checked', false);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const landTypeInvFillSelect = document.getElementById('landTypeInvFill');
            const flatDiv = document.getElementById('isPropertyDetailsNotFoundChecked');

            function toggleFlatDiv() {
                const selectedOption = landTypeInvFillSelect.options[landTypeInvFillSelect.selectedIndex];
                ...
                if (selectedOption.textContent.trim() === 'Nazul') {
                    ...
                    // Clear flat number input
                    $('#flat_no_after_Checked_Address_notfound').val('');
            ...
            // Add event listener
            landTypeInvFillSelect.addEventListener('change', toggleFlatDiv);
        });

        document.addEventListener('DOMContentLoaded', function() {
            const landTypeOrgFillSelect = document.getElementById('landTypeOrgFill');
            const flatDiv = document.getElementById('flatNoOrgDivAfterCheckedAddressNotFound');

            function toggleFlatDiv() {
                const selectedOption = landTypeOrgFillSelect.options[landTypeOrgFillSelect.selectedIndex];
                ...
                if (selectedOption.textContent.trim() === 'Nazul') {
                    ...
                    // Clear flat number input
                    $('#flat_no_org_after_checked_Address_notfound').val('');
            ...
            // Add event listener
            landTypeOrgFillSelect.addEventListener('change', toggleFlatDiv);
        });
        $(document).ready(function() {
