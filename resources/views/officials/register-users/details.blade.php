                        ...
                        <table class="table table-bordered property-table-info">
                            ...
                            <tbody>
                                ...
                                @if (!empty($data['details']->lease_deed_doc))
                                    <tr>
                                        <td>{{ $count++ }}</td>
                                        <td>Lease Deed/Conveyance Deed <span>(Any title document in the name of the applicant establishing ownership of the property.)</span></td>
                        ...
                        <form id="approvalForm" method="POST" action="{{ route('approve.user.registration') }}">
                            ...
                            <div class="container-fluid pb-3">
                                <div class="row">
                                    ...
                                    <div class="mis-view-group-btn d-flex align-items-start gap-3 flex-wrap">
                                        @if ($data['suggestedPropertyId'])
                                            ...
                                            <div class="btn-group" style="padding-top: 7px;">
                                                @php 
                                                if ($isSplited == 0) {
                                                    $url = route('viewDetails', ['property' => $data['propertyMasterId']]) 
                                                        . '?params=' . urlencode($additionalDataJson);
                                                } else {
                                                    $url = route('propertyChildDetails', ['id' => $splited_primary_id]) 
                                                        . '?params=' . urlencode($additionalDataJson);
                                                }
                                            @endphp
                                                <a href="{{ $url }}">
