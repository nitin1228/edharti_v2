        ...
        <div class="card-body">
            <div>
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center px-3">
                        @if(!empty($uniquePaymentId) && !empty($details->application_no))
                            <a href="{{ route('downloadPaymentReceiptPdfByAppNo', [
                            'id' => $uniquePaymentId,
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Disposed Date:
                                    <span class="highlight_value">
                                        {{ !empty($application->disposed_at) ? \Carbon\Carbon::parse($application->disposed_at)->format('d-m-Y') : '' }}
                                    </span>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div class="object_remarks">
             ...
             @if ($details->flatDetails && $applicationType != 'Deed Of Apartment')
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered property-table-info">
                                        <tbody>
                                            <tr>
                                                <th>Flat Id :</th>
                                                <td>{{ $details->flatDetails->unique_flat_id ?? '' }}</td>
                                                <th>File Number :</th>
                                                <td>{{ $details->flatDetails->unique_file_no ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>Floor :</th>
                                                <td>{{ $details->flatDetails->floor ?? '' }}</td>
                                                <th>Flat Number :</th>
                                                <td>{{ $details->flatDetails->flat_number ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>Flat Status :</th>
                                                <td>{{ optional($details->flatDetails)->property_flat_status == 951 ? 'Lease Hold' : 'Free Hold' }}
                                                </td>
                                                <th>Flat Area in Sqm :</th>
                                                <td>{{ $details->flatDetails->area_in_sqm ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>Purchase Date :</th>
                                                <td>{{ !empty($details->flatDetails->purchase_date) ? \Carbon\Carbon::parse($details->flatDetails->purchase_date)->format('d-m-Y') : '' }}
                                                </td>
                                                <th>Original Buyer :</th>
                                                <td>{{ $details->flatDetails->original_buyer_name ?? '' }}</td>
                                            </tr>
                                            <tr>
                                                <th>Present Occupant :</th>
                                                <td>{{ $details->flatDetails->present_occupant_name ?? '' }}</td>
                                                <th>Builder / Developer Name :</th>
                                                <td>{{ $details->flatDetails->builder_developer_name ?? '' }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
            ...
            <div class="part-title d-flex justify-content-between align-items-center">
                <h5>Name & Details of Registered Applicant</h5>
                 @if(auth()->user()->getRoleNames()->first() == 'CDV')
                                ...
                                <div class="table-responsive"> 
                                    <table class="table table-bordered property-table-info">
                                        <tbody>
                                            ...
                                            @if ($applicationType == 'Mutation' && auth()->user()->getRoleNames()->first() !== 'applicant')
                                                <tr>
            ...
            <div id="editApplicantSection" style="display:none">
                ...
                <div class="part-details">
                    <div class="container-fluid">
                        <form action="{{ route('applicant.cdv.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="applicant_id" value="{{ $user->id }}">
                            <input type="hidden" name="applicant_no" value="{{ $user->applicantUserDetails->applicant_number }}">
                            <input type="hidden" name="application_no" value="{{ $details->application_no }}">
                            <div class="row">
                                ...
                                <div class="col-md-5 mb-3">
                                 ...
                                 <div class="col-md-1 mb-3">
                                    ...
                                    <select name="gender" class="form-control">
                                        <option value="Male"
                                            {{ $user->applicantUserDetails->gender=='Male'?'selected':'' }}>
                                            Male
                                        </option>

                                        <option value="Female"
                                            {{ $user->applicantUserDetails->gender=='Female'?'selected':'' }}>
                                            Female
                                        </option>
                                    </select>
                                </div>
                                 ...
                                 <div class="col-md-2 mb-3">
                                    ...
                                    <select name="relation" class="form-control">
                                        <option value="S/o"
                                            {{ $user->applicantUserDetails->so_do_spouse=='S/o'?'selected':'' }}>
                                            S/o
                                        </option>

                                        <option value="D/o"
                                            {{ $user->applicantUserDetails->so_do_spouse=='D/o'?'selected':'' }}>
                                            D/o
                                        </option>

                                        <option value="Spouse Of"
                                            {{ $user->applicantUserDetails->so_do_spouse=='Spouse Of'?'selected':'' }}>
                                            Spouse Of
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text"
                                        name="second_name"
                                        class="form-control"
                                        value="{{ old('second_name',$user->applicantUserDetails->second_name) }}">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label>Address</label>

                                    <textarea name="address"
                                        class="form-control">{{ old('address',$user->applicantUserDetails->address) }}</textarea>
                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Share: <small class="text-danger">*</small><input
                                                                class="form-control"
                                                                name="coapplicantShare[{{ $key }}]" type="text"
                                                                placeholder="Enter Share Details"
                                                                value="{{ $coapplicant->share ?? '' }}" />
                                                            <input type="hidden"
                                                                name="coapplicantShareId[{{ $key }}]"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    @if (!empty($scannedFiles['files']))
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            ...
                            ($roles === 'section-officer' || $roles === 'assistant-section-officer') &&
                                auth()->user()->can('can.approve.application.mis.scanned.document')) onclick='checkScannedFiles()' @endif></button>
                    @else
                    ...
                    @if (!empty($scannedFiles['files']))
                        <ul class="files-link">
                            @foreach ($scannedFiles['files'] as $scannedFile)
                                         ...
                                         <li><a href="{{ $scannedFiles['baseUrl'] }}{{ $scannedFile['document_path']}}"
                                        target="_blank">{{ $scannedFile['document_name']}}</a></li>
                            @endforeach
                        </ul>
                    @else
                ...
                <div class="modal-footer justify-content-end">
                        ...
                        @if (
                            ($roles === 'section-officer' || $roles === 'assistant-section-officer') &&
                                auth()->user()->can('can.approve.application.mis.scanned.document')) onclick='checkScannedFiles()' @endif>Close</button>
                        @else
    ...
    <script>
        ...
        function handleApplicationAction(action, applicationNo, button, remark = null) {
            ...
            if (!needToconfirm) {
                ...
                if (allChecked) {
                     const applicationType = @json($applicationType);
