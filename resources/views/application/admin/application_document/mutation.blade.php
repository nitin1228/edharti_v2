                        ...
                        <thead>
                            <tr style="background-color: #f8f9fa; border: 1px solid #000;">
                                ...
                                @if($showCdvActionInDocuments && $roles != 'applicant')
                                    <th style="border: 1px solid #000; padding: 8px; text-align: center;">Found Correct</th>
                                @endif
                            </tr>
                        </thead>
                        <tbody>
                                                ...
                                                @foreach ($ud->documentKeys as $data)
                                                    @if(isset($document['inputs'][$data->key]['label']))
                                                        <div style="margin-bottom: 2px;">
                                                            <strong>{{ $document['inputs'][$data->key]['label'] }}:</strong> {{ $data->value }}
                                                        </div>
                                                    @endif
                                                @endforeach
                                            </div>
                                ...
                                @foreach ($cdvAdditionalDocuments as $ud)
                                    <tr style="border: 1px solid #000;">
                                        ...
                                        <td colspan="{{ $colspan - 1 }}" style="border: 1px solid #000; padding: 8px;">
                                            <div style="font-weight: bold;">{{ $ud['title'] }}</div>
                                        </td>
                                    </tr>
                                    @php $count++; @endphp
                                @endforeach
                                                    ...
                                                    @if ($roles != 'applicant')
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input required-for-approve property-document-approval-chk" type="checkbox" name="checkedAction" id="checkedAction" @if ($checkList && $checkList->is_uploaded_doc_checked == 1) checked disabled @endif @if ($roles != 'section-officer' &&
                                                                 $roles != 'assistant-section-officer' &&
                                                                 auth()->user()->can('can.approve.application.mis.scanned.document')) disabled @endif>
