        ...
        <tfoot>
            <tr class="table-secondary">
                ...
                <a href="javascript:;"
                           ...
                           data-service="all">     ₹ {{ customNumFormat(round($grandTotal, 2)) }}
                </th>
                <th></th>
            </tr>
        </tfoot>
        ...
        <tfoot>
            <tr class="table-secondary">
                ...
                <a href="javascript:;"
                           ...
                           data-service="allold">     ₹ {{ customNumFormat(round($grandTotal, 2)) }} </a>
                </th>
                <th></th>
            </tr>
        </tfoot>
...
<div class="row">
        <div class="col-lg-12 mb-4">
            <div class="card widget-card">
                <div class="card-body">
                    <h5 class="card-title"><!--Application Fee Payments Summary by Application Type-->Revenue Summary <!--Payment Summary--></h5>
                    <div class="table-responsive mt-2 mb-3">                      
					<table class="table table-bordered">
					    <thead>
					        <tr>
