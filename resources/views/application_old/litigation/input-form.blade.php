...
@php
    ...
    $allHearings = $isEdit && isset($litigation->hearings)
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active">
                    {{ $isEdit ? 'Edit Court Case' : 'Add Court Case' }}
                </li>
...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ $isEdit ? route('litigation.update', $litigation->id) : route('litigation.store') }}"
            method="POST"
            novalidate>
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-success" id="litigationSubmit">
