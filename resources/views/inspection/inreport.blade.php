...
<body>
    ...
    <div style="text-align: center"> <div class="emblem-div">
                    ...
                    <h1 class="title-sub">Sankalp Bhawan</h1> 
                     <h1 class="title-sub">New Delhi-110001</h1> </div>
       ...
       <div class="part-title"> Inspection Details</div>
						<table>
						    ...
						    <tr>
						        ...
						        <td>{{ $inspectionReportBind->seniorofficer->name ?? '****' }} </td>
						    </tr>
						    <tr>
						...
						@endif
						<div class="part-title">Misuse Breach Details </div>
								...
								<div class="part-title"> Encroachment  Breach Details </div>
    ...
    <table style="width:100%; border:none;">
        <tr>
            ...
            <td style="width:50%; border:none; text-align:right;">
                ({{ $inspectionReportBind->signingAuthority->name ?? '' }})
                <br>
                A.E.-I / A.E.-II / B.O.
            </td>
        </tr>
