...
<div class="card">
  ...
  <tbody>
        ...
        <tr>
            ...
            <td>{{ $comm->cname ?? 'N/A' }}</td>
            <td>{{ $comm->chouse ?? 'N/A' }}<br>{{ $comm->clocality ?? 'N/A' }}<br>{{ $comm->ccity ?? 'N/A' }}<br>{{ $comm->cpincode ?? 'N/A' }}</td>
            ...
            <td> @if($inspection->status == 0) <span class="badge bg-warning"> Pending </span>
                ...
                @endif
                @if($inspection->reopen == 1 && $inspection->status == 0) <span class="badge bg-danger"> Reopen </span>@endif
            </td>
		          <td>
    ...
    <a href="{{ route('inspection.action',['id' => $inspection->id, 'type' => 'finalreport']) }}"> <button class="btn btn-success btn-sm"><i class="fas fa-file-pdf"></i>Final Report</button> </a> 
            ...
            <a href="{{ route('inspection.action',['id' => $inspection->id, 'type' => 'edit'])}}"><button class="btn btn-warning btn-sm"> Edit Request </button> </a> @endif
