...
<body>
    ...
    <div class="content-wrap">
        ...
        <div class="content">It is submitted that request for <b>{{ getServiceNameById($inspection->inspection_reason) }} </b>
        is under consideration for Property ID: <b> {{ $inspection->property_id }}</b> known as  <b>{{ $inspection->property_known_as }} </b>.
    ...
    <div class="remarks">
        <span class="bold"> Remarks : </span>{{ $inspection->cremarks ?? 'N/A' }}    </div>
