...
@endhaspermission
                ...
                @haspermission('registrations.listing')
                     <li>
                        <a href="javascript:;" class="has-arrow">
                        ...
                        <ul>
                            <li class="{{ request()->is('register/users') ? 'active' : '' }}">
                                <a href="{{ route('regiserUserListings') }}"><i
                    ...
                    <li>
                        ...
                        <ul>
                            @haspermission('list.application')
                                ...
                                @if(!auth()->user()->hasRole('Joint Secretary'))
                ...
                @haspermission('view reports')
                    <li>
                        ...
                        <ul>
                            ...
                            @can('registrations.and.applications.reports')
                                <li class="{{ request()->routeIs('registrations.report') ? 'active' : '' }}">
                                    <a href="{{ route('registrations.report') }}">
                                        <i class="bx bx-right-arrow-alt"></i>Registrations And Applications Report
                                    </a>
                                </li>                                                               
                            @endcan

                            @can('thirty.days.old.pending.application.report')
                                <li class="{{ request()->is('old-pending-records') ? 'active' : '' }}"> <a
                                        href="{{ route('old.pending.records') }}"><i
                                            class="bx bx-right-arrow-alt"></i>30+ Days Old Pending Requests</a>
                                </li>
                            @endcan
                                {{-- code added show lease hold property listing --}}
                                <li class="{{ request()->is('lease-hold-demands') ? 'active' : '' }}"> <a
                                        href="{{ route('leaseHoldDemands') }}"><i
                ...
                @can('view.financial.reports')
                    <li>
                        ...
                        <ul>
                            @can('revenue.create')
                                <li class="{{ request()->is('revenues.index') ? 'active' : '' }}"> <a
                                        href="{{ route('revenues.index') }}"><i
                                            class="bx bx-right-arrow-alt"></i>Create Revenue</a>
                                </li>
                            @endcan
                            <li class="{{ request()->is('paymentSummary') ? 'active' : '' }}">
                                <a href="{{ route('paymentSummary') }}"><i class="bx bx-right-arrow-alt"></i>Revenue Summary</a>
                            </li>
                        </ul>
                    </li>
                @endcan
                ...
                -->
                 @can('view.payment.reports')
                    <li>
                        ...
                        <ul>
                            <!-- <li class="{{ request()->is('paymentReport') ? 'active' : '' }}">
                            ...
                            <li class="{{ request()->is('paymentReport') ? 'active' : '' }}">
                                <a href="{{ route('paymentReport') }}"><i class="bx bx-right-arrow-alt"></i>Payment Report</a>
                            </li>
                            @can('add.manual.payment')
                            <li class="{{ request()->is('manualPaymentInputForm') ? 'active' : '' }}">
                                <a href="{{ route('manualPaymentInputForm') }}"><i class="bx bx-right-arrow-alt"></i>Manual Payments</a>
                            </li>
                            @endcan
                        </ul>
                    </li>
                ...
                @can('view.litigation.list')
                    <li>
                        ...
                        <ul>
                            <li><a href="{{ route('litigation.create') }}"><i class='bx bx-chevron-right'></i>Add Court Case</a></li>
                            <li><a href="{{ route('litigation.index') }}"><i
                ...
                <li>
                    ...
                    <ul>
                        ...
                        @can('old.demand.list')
                        <li class="{{ request()->is('oldDemandList') ? 'active' : '' }}"> <a
                                href="{{ route('oldDemandList') }}"><i class="bx bx-right-arrow-alt"></i>eDharti 1.0 Demands</a>
                        </li>
                        @endcan
                    </ul>
                </li>
                ...
                @endcanany
@canany(['create.inspection', 'view.inspection'])
                    <li>
                        <a href="javascript:;" class="has-arrow">
                        ...
                        <ul>    
                            ...
                            <li class="{{ request()->is('inspectionRequest') ? 'active' : '' }}"> <a href="{{ route('inspectionRequest') }}"><i class="bx bx-right-arrow-alt"></i>Create Inspection</a> </li>
                             @endcan
                            <li class="{{ request()->is('inspectionlist') ? 'active' : '' }}"> <a href="{{ route('inspectionlist') }}"><i class="bx bx-right-arrow-alt"></i>View  Inspection</a>
                            </li>                                                   
                        </ul>
                    </li>
                @endcanany
                @can('miscellaneous')
                    <li>
                        ...
                        <ul>
                            ...
                            @endcan
                            @role('super-admin')
                                <li> <a href="{{ route('admin.rollback') }}"><i
                                                class="bx bx-right-arrow-alt"></i>Application Rollback</a>
                                </li>
                            @endhasrole
                            @role('super-admin')
                                <li> <a href="{{ route('payment.livestatus.search') }}"><i
    ...
    @if(session('hide_old_records_popup'))
        {{ session()->forget('hide_old_records_popup') }}
    <!-- Old Registrations Modal - Shows on any page when session has data -->
    @elseif(session('show_old_records_popup') && session('old_records_data') && count(session('old_records_data')) > 0)
    <!-- CSS Styles -->
    <style>
        /* Custom modal styles */
        .modal-xl {
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead style="position: sticky; top: 0; background-color: #f8f9fa; z-index: 10;">
                                <tr>
                                    ...
                                    <th style="width: 18%; min-width: 180px;">{{ $record['name_label'] ?? 'Name/Details' }}</th>
                            ...
                            <tbody>
                                @foreach (session('old_records_data') as $index => $record)
                                    <tr id="row-{{ $record['type'] }}-{{ $record['id'] }}" 
                                        class="row-{{ $record['type'] }}"
                                        style="vertical-align: middle;">
                                        <td><strong>{{ $index + 1 }}</strong></td>
                                        <td>
                                            <span class="badge badge-{{ $record['type'] == 'registration' ? 'registration' : 'application' }}">
                                                <i class="fas fa-{{ $record['type'] == 'registration' ? 'user-plus' : 'file-alt' }}"></i>
                                                {{ $record['type_label'] }}
                                            </span>
                                        </td>
                                        <td>
                                            ...
                                            <br>
                                            <small class="text-muted">{{ $record['identifier_label'] }}</small> --}}
                                            @php
                                        ...
                                        <td>
                                            {{ $record['name'] }}
                                            {{-- @if($record['type'] == 'application' && isset($record['created_by']))
                                                <br>
                                                <small class="text-muted">User ID: {{ $record['created_by'] }}</small>
                                            @endif
                                            @if($record['type'] == 'registration')
                                                <br>
                                                <small class="text-muted">Reg ID: {{ $record['id'] }}</small>
                                            @endif --}}
                                        </td>
                                        <td>
                                            {{ \Carbon\Carbon::parse($record['created_at'])->format('d-m-Y') }}
                                            <br>
                                            <small class="text-muted">{{ \Carbon\Carbon::parse($record['created_at'])->format('h:i A') }}</small>
                                        </td>
                                        <td>
                                            <span class="badge badge-danger" style="font-size: 14px; padding: 6px 12px;">
                                                <i class="fas fa-hourglass-half"></i>
                                                {{ \Carbon\Carbon::parse($record['created_at'])->diffInDays(now()) }} days
                                            </span>
                                        </td>
                                        <td>
                                            <textarea id="remark-{{ $record['type'] }}-{{ $record['id'] }}" 
                                                    ...
                                                    maxlength="1000">{{ $record['pending_remark'] ?? '' }}</textarea>
                                            <div class="d-flex justify-content-between mt-1">
                                                <small class="text-muted">
                                                    <i class="fas fa-info-circle"></i> Press Ctrl+Enter to submit
                                                </small>
                                                <small class="char-counter text-muted" id="char-count-{{ $record['type'] }}-{{ $record['id'] }}">
                                                    {{ strlen($record['pending_remark'] ?? '') }}/1000 characters
                                                </small>
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div class="d-flex justify-content-between w-100">
                        <div>
                            <span class="text-muted">
                                <i class="fas fa-list"></i> Total Records: {{ count(session('old_records_data')) }}
                            </span>
                        </div>
                        <div>
                            <span class="text-muted">
                                <i class="fas fa-user-plus"></i> Registrations: 
                                {{ collect(session('old_records_data'))->where('type', 'registration')->count() }}
                            </span>
                            <span class="text-muted ml-3">
                                <i class="fas fa-file-alt"></i> Applications: 
                                {{ collect(session('old_records_data'))->where('type', 'application')->count() }}
                            </span>
                            
                            <a href="{{ url('/edharti/dashboard') }}" class="btn btn-sm btn-primary">
            ...
            function submitRemark(recordId, recordType, identifier, remarkText, $button, $textarea) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // Make AJAX request
                        $.ajax({
                            url: '{{ route("old.record.update.pending.remark") }}',
                            type: 'POST',
                            data: postData,
                            dataType: 'json',
