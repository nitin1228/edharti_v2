...
<div class="row row-cols-2 row-cols-md-2 row-cols-xl-4 custom_card_container  outside-tiles">
    ...
    @if (Auth::user()->hasRole('lndo') && Auth::user()->can('thirty.days.old.pending.application.report'))
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center dashboard-cards">
                            <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin"><img
                                    src="{{ asset('assets/images/sell-30.svg') }}" alt="properties">
                            </div>
                            <div>

                                <h4 class="my-1 grid-icons-size text-dark view-list" id="outside_count"
                                    data-filter-value="pending_request">{{ $totalOldRecordsCount ?? 0 }}</h4>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center dashboard-cards">
                            <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin"><img
                                    src="{{ asset('assets/images/properties-icon-hand-30.svg') }}"
                                    alt="properties">
                            </div>
                            <div>

                                <h4 class="my-1 grid-icons-size text-dark view-list" id="outside_count"
                                    data-filter-value="pending_request">{{ $totalOldRegistrationsCount ?? 0 }}
                                </h4>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center dashboard-cards">
                            <div class="widgets-icons-2 rounded-circle text-white mr-icons-margin"><img
                                    src="{{ asset('assets/images/pageless-30.svg') }}" alt="properties">
                            </div>
                            <div>

                                <h4 class="my-1 grid-icons-size text-dark view-list" id="outside_count"
                                    data-filter-value="pending_request">{{ $totalOldApplicationsCount ?? 0 }}</h4>
...
--}}
            ...
            @if($applicationCountData && Auth::user()->can('view.application.reports'))
                {{--<div class="col-lg-12 col-12" style="margin-bottom: 25px;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $services = getAllItemsByGroupId(17001);
                                        ...
                                        @foreach ($services as $service)
                                            ...
                                            <tr>
                                                ...
                                                @endphp
                                                <td><a href="{{route('applicationSummaryDetails')}}?status=APP_NEW%2CAPP_PEN&service={{$service->item_code}}" target="_blank">{{$newCount + $pendingCount}}</a>
                                                    @php
                                                        $totalApps[0] += $newCount + $pendingCount;
                                                    @endphp
                                                </td>
                                                <td><a href="{{route('applicationSummaryDetails')}}?status=APP_IP%2CAPP_OBJ%2CAPP_HOLD&service={{$service->item_code}}" target="_blank">{{$inProgressCount + $objectedCount + $holdCount}}</a>
                                                    @php
                                                        $totalApps[1] += $inProgressCount + $objectedCount + $holdCount;
                                                    @endphp
                                                </td>

                                                <td><a href="{{route('applicationSummaryDetails')}}?status=APP_APR%2CAPP_REJ%2CAPP_CAN&service={{$service->item_code}}" target="_blank">{{$approvedCount + $rejectedCount + $cancelledCount}}</a>
                                                    @php
                                        ...
                                        <tr>
                                            <th>Total</th>
                                            <th><a href="{{route('applicationSummaryDetails')}}?status=APP_NEW%2CAPP_PEN" target="_blank">{{$totalApps[0]}}</a></th>
                                            <th><a href="{{route('applicationSummaryDetails')}}?status=APP_IP%2CAPP_OBJ%2CAPP_HOLD" target="_blank">{{$totalApps[1]}}</a></th>
                                            <th><a href="{{route('applicationSummaryDetails')}}?status=APP_APR%2CAPP_REJ%2CAPP_CAN" target="_blank">{{$totalApps[2]}}</a></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
