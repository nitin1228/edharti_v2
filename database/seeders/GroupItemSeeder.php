...
class GroupItemSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            [
                'group_id' => 7003,
                'item_code' => 'DEM_SETTLED_AMOUNT',
                'item_name' => 'Offline settled amount',
                'item_order' => 1,
                'is_active' => 1,
                //'additional_data' => ['remarks' => true],
            ],
            ...
            [
                'group_id' => 7003,
                'item_code' => 'DEM_DEF_CONV',
                'item_name' => 'Differential Conversion Charges',
                'item_order' => 1,
            ],
            /* [
                'group_id' => 7003,
                'item_code' => 'DEM_SUPL_LES_CHG',
                'item_name' => 'Supplementary Lease Charges',
                'item_order' => 1,
            ], */
            /** Payment status */
            [
